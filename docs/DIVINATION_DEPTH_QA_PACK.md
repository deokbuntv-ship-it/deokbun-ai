...
- 일간 강약: 신강
- 용신: 일간이 신강이라 힘을 덜어 주는 목을 용신으로 봅니다(억부).
- SUBJUDGMENTS:
    ...
    - CAREER = AGAINST (DAEWOON/GENERAL) — 이 부분은 부딪히는 지점이 있어 범위를 좁히는 쪽이 낫습니다.
- COUNTER_EVIDENCE:
    - 이 시기 흐름 기운이 기신 쪽 — 들어오는 금 기운이 지금 필요한 방향과 반대로 작용합니다.
    - 이 시기 흐름 기운이 기신 쪽 — 들어오는 금 기운이 지금 필요한 방향과 반대로 작용합니다.
    - 이 시기 흐름 기운이 기신 쪽 — 들어오는 금 기운이 지금 필요한 방향과 반대로 작용합니다.
...
- NEW_INFERENCE = 재백에 막히는 기운이 들어와, 이 부분은 수월하게 풀리지 않습니다. 다만 돈이 들어오는 것과 남는 것은 다르게 봅니다.
- INFERENCE_IS_PRIMITIVE_FACT = NO (축별 판정 + 교차 추론으로 새로 도출)
- SUPPORTED_BY = 원국 바탕(MONEY_RETENTION) / 원국 재성 2자리 / 원국 통근 튼튼
- COUNTER_EVIDENCE_REF = 재백(본궁)에 천동 화기 / 이 시기 흐름 기운이 기신 쪽 / 재백(삼합궁)에 천동 화기
...
- MAJOR_FACTS_USED: 원국 십신 배치, 원국 합충형파해, 월령, 통근·투간, 일간 강약(억부), 용신(억부), 대운, 세운, 월운, 원국×운 관계(종류·위치)
- 일간 강약: 중화신강
- 용신: 일간이 중화신강이라 힘을 덜어 주는 토을 용신으로 봅니다(억부).
- SUBJUDGMENTS:
    - MONEY_INFLOW = INSUFFICIENT_EVIDENCE (NATAL/DIRECT) — 지금 이 부분을 흔드는 흐름은 따로 없습니다.
    - MONEY_RETENTION = CONDITIONAL_FOR (NATAL/ADJACENT) — 들어온 것을 지키는 구조는 크게 새지 않습니다.
    - OPPORTUNITY = INSUFFICIENT_EVIDENCE (NATAL/ADJACENT) — 지금 이 부분을 흔드는 흐름은 따로 없습니다.
...
- COUNTER_EVIDENCE:
    - 올해 흐름 기운이 기신 쪽 — 들어오는 화 기운이 지금 필요한 방향과 반대로 작용합니다.
    - 올해 흐름 기운이 기신 쪽 — 들어오는 화 기운이 지금 필요한 방향과 반대로 작용합니다.
...
### CROSS
- SAME_PROPOSITION_CONFLICT = 명리와 자미두수가 돈이 남는 쪽을 반대로 봅니다.
- DOMAIN_DECOMPOSITION = 자리가 열리는 것과 실속이 남는 것은 다르게 봅니다. 서로 다른 축이라 둘 다 사실입니다.
- TEMPORAL_DECOMPOSITION = 없음
- AXIS_VERDICTS = MONEY_RETENTION:CONDITIONAL_FOR(경합) · CAREER:CONDITIONAL_AGAINST
- DOMINANT_EVIDENCE = 명리 · 원국 바탕(MONEY_RETENTION)
- LOSING_EVIDENCE = 자미두수가 본 자녀(대궁)에 태음 화록도 사실이지만, 근거의 결이 한 단계 멀어 결론을 가져가지 못했습니다. / 질문의 축과 다른 축이라 결론을 뒤집지 않고 조건으로 붙습니다.
- RESOLUTION = 학문 사이의 차이를 근거의 직접성과 축·시점 기준으로 정리했습니다.
- **FINAL_VERDICT = CONDITIONAL_FOR** (확신 MEDIUM)
- NEW_INFERENCE = 들어온 것을 지키는 구조는 크게 새지 않습니다. 다만 자리가 열리는 것과 실속이 남는 것은 다르게 봅니다.
- INFERENCE_IS_PRIMITIVE_FACT = NO (축별 판정 + 교차 추론으로 새로 도출)
- SUPPORTED_BY = 원국 바탕(MONEY_RETENTION) / 지금의 큰 흐름 기운이 용신에 부합 / 원국 재성 4자리
- COUNTER_EVIDENCE_REF = 올해 흐름 기운이 기신 쪽 / 지금의 큰 흐름에 겁재 / 지금의 큰 흐름 → 원국 월주 해
- DISCIPLINES_CONTRIBUTING = MYUNGRI+ZIWEI
- TEMPORAL_SCOPE = NATAL
- TRACEABLE = YES
...
- 결론: 흐름 자체가 지금 이 사주에 필요한 기운으로 들어오고 있습니다.
- MAJOR_FACTS_USED: 원국 십신 배치, 원국 합충형파해, 월령, 통근·투간, 일간 강약(억부), 용신(억부), 대운, 세운, 월운, 원국×운 관계(종류·위치)
- 일간 강약: 신강
- 용신: 일간이 신강이라 힘을 덜어 주는 화을 용신으로 봅니다(억부).
- SUBJUDGMENTS:
    - MONEY_INFLOW = CONDITIONAL_FOR (NATAL/DIRECT) — 흐름 자체가 지금 이 사주에 필요한 기운으로 들어오고 있습니다.
    - MONEY_RETENTION = CONDITIONAL_FOR (NATAL/ADJACENT) — 흐름 자체가 지금 이 사주에 필요한 기운으로 들어오고 있습니다.
    - OPPORTUNITY = CONDITIONAL_FOR (NATAL/ADJACENT) — 흐름 자체가 지금 이 사주에 필요한 기운으로 들어오고 있습니다.
    - CAREER = FOR (WOLWOON/GENERAL) — 이 부분은 흐름이 맞물려 열리는 편입니다.
- COUNTER_EVIDENCE:
...
- TEMPORAL_DECOMPOSITION = 없음
- AXIS_VERDICTS = MONEY_INFLOW:CONDITIONAL_FOR · MONEY_RETENTION:STRONGLY_FOR · OPPORTUNITY:CONDITIONAL_FOR · CAREER:FOR
- DOMINANT_EVIDENCE = 명리 · 원국 바탕(MONEY_INFLOW)
- LOSING_EVIDENCE = 없음
- RESOLUTION = 여러 축의 신호가 같은 방향으로 모입니다.
- **FINAL_VERDICT = CONDITIONAL_FOR** (확신 HIGH)
- NEW_INFERENCE = 흐름 자체가 지금 이 사주에 필요한 기운으로 들어오고 있습니다.
- INFERENCE_IS_PRIMITIVE_FACT = NO (축별 판정 + 교차 추론으로 새로 도출)
- SUPPORTED_BY = 원국 바탕(MONEY_INFLOW) / 지금의 큰 흐름 기운이 용신에 부합 / 올해 흐름 기운이 용신에 부합
...
### MYUNGRI
- PRIMARY = **AGAINST** (근거강도 STRONG · 확신 MEDIUM · 직접성 ADJACENT · 자료 EXACT)
- 결론: 이 부분은 부딪히는 지점이 있어 범위를 좁히는 쪽이 낫습니다.
- MAJOR_FACTS_USED: 원국 십신 배치, 원국 합충형파해, 월령, 통근·투간, 일간 강약(억부), 용신(억부), 대운, 세운, 월운, 원국×운 관계(종류·위치)
- 일간 강약: 신강
- 용신: 일간이 신강이라 힘을 덜어 주는 목을 용신으로 봅니다(억부).
- SUBJUDGMENTS:
    - CAREER = AGAINST (DAEWOON/ADJACENT) — 이 부분은 부딪히는 지점이 있어 범위를 좁히는 쪽이 낫습니다.
    - OUTCOME = CONDITIONAL_FOR (WOLWOON/GENERAL) — 원국에 자리·책임 자리가 3곳 있어 바탕이 받쳐 줍니다. 흐름도 맞물려 열리는 자리입니다.
    - OPPORTUNITY = INSUFFICIENT_EVIDENCE (NATAL/GENERAL) — 지금 이 부분을 흔드는 흐름은 따로 없습니다.
...
- DOMAIN_DECOMPOSITION = 없음
- TEMPORAL_DECOMPOSITION = 없음
- AXIS_VERDICTS = CAREER:FOR(경합) · OUTCOME:CONDITIONAL_FOR · MOVEMENT:CONDITIONAL_FOR · GENERAL:CONDITIONAL_AGAINST · TIMING:FOR
- DOMINANT_EVIDENCE = 자미두수 · 부처(삼합궁)에 태양 화록
- LOSING_EVIDENCE = 명리가 본 원국 바탕(CAREER)도 사실이지만, 근거의 결이 한 단계 멀어 결론을 가져가지 못했습니다.
- RESOLUTION = 학문 사이의 차이를 근거의 직접성과 축·시점 기준으로 정리했습니다.
- **FINAL_VERDICT = CONDITIONAL_FOR** (확신 MEDIUM)
- NEW_INFERENCE = 천이은 맞물린 자리에서 힘을 받는 편입니다.
- INFERENCE_IS_PRIMITIVE_FACT = NO (축별 판정 + 교차 추론으로 새로 도출)
- SUPPORTED_BY = 관록(본궁)에 태음 화과 / 부처(대궁)에 태양 화록 / 지금의 큰 흐름 → 원국 시주 반합
- COUNTER_EVIDENCE_REF = 재백(삼합궁)에 천동 화기 / 이 시기 흐름 기운이 기신 쪽 / 재백(삼합궁)에 천동 화기
- DISCIPLINES_CONTRIBUTING = MYUNGRI+ZIWEI+QIMEN
...
### MYUNGRI
- PRIMARY = **AGAINST** (근거강도 STRONG · 확신 MEDIUM · 직접성 GENERAL · 자료 EXACT)
- 결론: 이 부분은 부딪히는 지점이 있어 범위를 좁히는 쪽이 낫습니다.
- MAJOR_FACTS_USED: 원국 십신 배치, 원국 합충형파해, 월령, 통근·투간, 일간 강약(억부), 용신(억부), 대운, 세운, 월운, 원국×운 관계(종류·위치)
- 일간 강약: 신강
- 용신: 일간이 신강이라 힘을 덜어 주는 목을 용신으로 봅니다(억부).
- SUBJUDGMENTS:
    - GENERAL = AGAINST (WOLWOON/GENERAL) — 이 부분은 부딪히는 지점이 있어 범위를 좁히는 쪽이 낫습니다.
    - CAREER = AGAINST (DAEWOON/GENERAL) — 이 부분은 부딪히는 지점이 있어 범위를 좁히는 쪽이 낫습니다.
...
- DOMAIN_DECOMPOSITION = 없음
- TEMPORAL_DECOMPOSITION = 없음
- AXIS_VERDICTS = GENERAL:AGAINST · CAREER:AGAINST · RELATION_STABILITY:AGAINST
- DOMINANT_EVIDENCE = 명리 · 올해 흐름 → 원국 년주 자형
- LOSING_EVIDENCE = 없음
- RESOLUTION = 여러 축의 신호가 같은 방향으로 모입니다.
- **FINAL_VERDICT = AGAINST** (확신 MEDIUM)
- NEW_INFERENCE = 이 부분은 부딪히는 지점이 있어 범위를 좁히는 쪽이 낫습니다.
- INFERENCE_IS_PRIMITIVE_FACT = NO (축별 판정 + 교차 추론으로 새로 도출)
- SUPPORTED_BY = (없음)
- COUNTER_EVIDENCE_REF = 올해 흐름 → 원국 년주 자형 / 이 시기 흐름 → 원국 년주 파 / 이 시기 흐름 기운이 기신 쪽
- DISCIPLINES_CONTRIBUTING = MYUNGRI+ZIWEI
...
- 결론: 이 부분은 부딪히는 지점이 있어 범위를 좁히는 쪽이 낫습니다.
- 시기: (근거 없음 — 시점 언급 금지)
- 학문별 기여: MYUNGRI=AGAINST · ZIWEI=INSUFFICIENT_EVIDENCE · QIMEN=미적용
...
- SUBJUDGMENTS:
    - OPPORTUNITY = INSUFFICIENT_EVIDENCE (NATAL/ADJACENT) — 지금 이 부분을 흔드는 흐름은 따로 없습니다.
    - OUTCOME = CONDITIONAL_FOR (WOLWOON/ADJACENT) — 원국에 자리·책임 자리가 3곳 있어 바탕이 받쳐 줍니다. 흐름도 맞물려 열리는 자리입니다.
    - MONEY_INFLOW = INSUFFICIENT_EVIDENCE (NATAL/GENERAL) — 지금 이 부분을 흔드는 흐름은 따로 없습니다.
    - CAREER = AGAINST (DAEWOON/GENERAL) — 이 부분은 부딪히는 지점이 있어 범위를 좁히는 쪽이 낫습니다.
- COUNTER_EVIDENCE:
    - 이 시기 흐름 기운이 기신 쪽 — 들어오는 금 기운이 지금 필요한 방향과 반대로 작용합니다.
...
- DOMAIN_DECOMPOSITION = 없음
- TEMPORAL_DECOMPOSITION = 없음
- AXIS_VERDICTS = OUTCOME:CONDITIONAL_FOR · MONEY_INFLOW:AGAINST · CAREER:FOR(경합) · GENERAL:CONDITIONAL_AGAINST · TIMING:FOR
- DOMINANT_EVIDENCE = 자미두수 · 관록(본궁)에 태음 화과
- LOSING_EVIDENCE = 명리가 본 원국 바탕(CAREER)도 사실이지만, 근거의 결이 한 단계 멀어 결론을 가져가지 못했습니다.
- RESOLUTION = 학문 사이의 차이를 근거의 직접성과 축·시점 기준으로 정리했습니다.
- **FINAL_VERDICT = FOR** (확신 MEDIUM)
- NEW_INFERENCE = 관록에 힘이 실려 열려 있는 자리입니다.
- INFERENCE_IS_PRIMITIVE_FACT = NO (축별 판정 + 교차 추론으로 새로 도출)
- SUPPORTED_BY = 지금의 큰 흐름 → 원국 시주 반합 / 올해 흐름 → 원국 시주 육합 / 이 시기 흐름 → 원국 시주 반합
- COUNTER_EVIDENCE_REF = 이 시기 흐름 기운이 기신 쪽 / 재백(본궁)에 천동 화기 / 재백(삼합궁)에 천동 화기
- DISCIPLINES_CONTRIBUTING = MYUNGRI+ZIWEI+QIMEN
...
- RESOLUTION = 학문 사이의 차이를 근거의 직접성과 축·시점 기준으로 정리했습니다.
- **FINAL_VERDICT = FOR** (확신 MEDIUM)
- NEW_INFERENCE = 원국에 자리·책임 자리가 3곳 있어 바탕이 받쳐 줍니다. 흐름도 맞물려 열리는 자리입니다.
- INFERENCE_IS_PRIMITIVE_FACT = NO (축별 판정 + 교차 추론으로 새로 도출)
...
- COUNTER_EVIDENCE:
    - 올해 흐름 기운이 기신 쪽 — 들어오는 화 기운이 지금 필요한 방향과 반대로 작용합니다.
    - 이 시기 흐름 기운이 기신 쪽 — 들어오는 화 기운이 지금 필요한 방향과 반대로 작용합니다.
...
- RESOLUTION = 여러 축의 신호가 같은 방향으로 모입니다.
- **FINAL_VERDICT = CONDITIONAL_FOR** (확신 MEDIUM)
- NEW_INFERENCE = 이 부분은 열리는 힘과 부딪히는 힘이 함께 있어, 조건을 정리하고 가야 합니다.
- INFERENCE_IS_PRIMITIVE_FACT = NO (축별 판정 + 교차 추론으로 새로 도출)
- SUPPORTED_BY = 올해 흐름 → 원국 시주 천간합 / 이 시기 흐름 → 원국 시주 천간합 / 원국 바탕(OUTCOME)
- COUNTER_EVIDENCE_REF = 지금의 큰 흐름 → 원국 시주 파 / 올해 흐름 → 원국 시주 파 / 올해 흐름 기운이 기신 쪽
- DISCIPLINES_CONTRIBUTING = MYUNGRI+ZIWEI+QIMEN
- TEMPORAL_SCOPE = NATAL/PRESENT_MOMENT
- TRACEABLE = YES
...
- SUBJUDGMENTS:
    ...
    - MONEY_INFLOW = CONDITIONAL_FOR (NATAL/GENERAL) — 흐름 자체가 지금 이 사주에 필요한 기운으로 들어오고 있습니다.
    - CAREER = CONDITIONAL_FOR (DAEWOON/GENERAL) — 이 부분은 부딪히는 지점이 있어 범위를 좁히는 쪽이 낫습니다.
- COUNTER_EVIDENCE:
    - 지금의 큰 흐름 → 원국 월주 해 — 사회·직업 자리가 이 흐름에 직접 흔들립니다.
...
### CROSS
- SAME_PROPOSITION_CONFLICT = 명리와 자미두수가 돈이 들어오는 쪽을 반대로 봅니다.
- DOMAIN_DECOMPOSITION = 없음
- TEMPORAL_DECOMPOSITION = 없음
- AXIS_VERDICTS = OPPORTUNITY:CONDITIONAL_FOR · OUTCOME:FOR · MONEY_INFLOW:AGAINST(경합) · CAREER:FOR · GENERAL:CONDITIONAL_AGAINST
- DOMINANT_EVIDENCE = 명리 · 지금의 큰 흐름 → 원국 시주 반합
- LOSING_EVIDENCE = 명리가 본 원국 바탕(MONEY_INFLOW)도 사실이지만, 근거의 결이 한 단계 멀어 결론을 가져가지 못했습니다.
- RESOLUTION = 학문 사이의 차이를 근거의 직접성과 축·시점 기준으로 정리했습니다.
- **FINAL_VERDICT = FOR** (확신 MEDIUM)
- NEW_INFERENCE = 원국에 자리·책임 자리가 3곳 있어 바탕이 받쳐 줍니다. 흐름도 맞물려 열리는 자리입니다.
- INFERENCE_IS_PRIMITIVE_FACT = NO (축별 판정 + 교차 추론으로 새로 도출)
- SUPPORTED_BY = 원국 바탕(OPPORTUNITY) / 이 시기 흐름 기운이 용신에 부합 / 지금의 큰 흐름 → 원국 시주 반합
- COUNTER_EVIDENCE_REF = 재백(본궁)에 천동 화기 / 재백(삼합궁)에 천동 화기 / 재백(삼합궁)에 천동 화기
- DISCIPLINES_CONTRIBUTING = MYUNGRI+ZIWEI
- TEMPORAL_SCOPE = NATAL
- TRACEABLE = YES
...
- 결론: 원국에 자리·책임 자리가 3곳 있어 바탕이 받쳐 줍니다. 흐름도 맞물려 열리는 자리입니다.
- 시기: (근거 없음 — 시점 언급 금지)
- 학문별 기여: MYUNGRI=CONDITIONAL_FOR · ZIWEI=FOR · QIMEN=미적용
...
- 용신: 일간이 신강이라 힘을 덜어 주는 목을 용신으로 봅니다(억부).
- SUBJUDGMENTS:
    - GENERAL = AGAINST (WOLWOON/DIRECT) — 이 부분은 부딪히는 지점이 있어 범위를 좁히는 쪽이 낫습니다.
    - CAREER = AGAINST (DAEWOON/GENERAL) — 이 부분은 부딪히는 지점이 있어 범위를 좁히는 쪽이 낫습니다.
    - RELATION_STABILITY = AGAINST (WOLWOON/GENERAL) — 이 부분은 직접 흔들리는 자리가 있어, 그대로 밀고 가기 어렵습니다.
    - MONEY_INFLOW = INSUFFICIENT_EVIDENCE (NATAL/GENERAL) — 지금 이 부분을 흔드는 흐름은 따로 없습니다.
- COUNTER_EVIDENCE:
...
- DOMAIN_DECOMPOSITION = 없음
- TEMPORAL_DECOMPOSITION = 가는 방향 자체는 맞지만, 지금 이 시점은 아닙니다.
- AXIS_VERDICTS = GENERAL:AGAINST · CAREER:FOR(경합) · RELATION_STABILITY:FOR_BUT_LATER(경합)
- DOMINANT_EVIDENCE = 명리 · 올해 흐름 → 원국 년주 자형
...
- NEW_INFERENCE = 이 부분은 부딪히는 지점이 있어 범위를 좁히는 쪽이 낫습니다.
- INFERENCE_IS_PRIMITIVE_FACT = NO (축별 판정 + 교차 추론으로 새로 도출)
- SUPPORTED_BY = 이 시기 흐름 → 원국 일주 천간합 / 지금의 큰 흐름 기운이 용신에 부합
- COUNTER_EVIDENCE_REF = 지금의 큰 흐름 → 원국 월주 해 / 올해 흐름 → 원국 월주 해 / 올해 흐름 기운이 기신 쪽
- DISCIPLINES_CONTRIBUTING = MYUNGRI+ZIWEI
...
- 용신: 일간이 신강이라 힘을 덜어 주는 화을 용신으로 봅니다(억부).
- SUBJUDGMENTS:
    - GENERAL = FOR (SEWOON/DIRECT) — 이 부분은 흐름이 맞물려 열리는 편입니다.
    - CAREER = FOR (WOLWOON/GENERAL) — 이 부분은 흐름이 맞물려 열리는 편입니다.
    - RELATION_STABILITY = CONDITIONAL_FOR (WOLWOON/GENERAL) — 이 부분은 부딪히는 지점이 있어 범위를 좁히는 쪽이 낫습니다.
    - MONEY_INFLOW = CONDITIONAL_FOR (NATAL/GENERAL) — 흐름 자체가 지금 이 사주에 필요한 기운으로 들어오고 있습니다.
- COUNTER_EVIDENCE:
...
- DOMAIN_DECOMPOSITION = 없음
- TEMPORAL_DECOMPOSITION = 없음
- AXIS_VERDICTS = GENERAL:FOR · CAREER:FOR · RELATION_STABILITY:CONDITIONAL_FOR · MONEY_INFLOW:CONDITIONAL_FOR
- DOMINANT_EVIDENCE = 명리 · 지금의 큰 흐름 → 원국 년주 반합
- LOSING_EVIDENCE = 없음
- RESOLUTION = 여러 축의 신호가 같은 방향으로 모입니다.
- **FINAL_VERDICT = FOR** (확신 HIGH)
- NEW_INFERENCE = 이 부분은 흐름이 맞물려 열리는 편입니다.
- INFERENCE_IS_PRIMITIVE_FACT = NO (축별 판정 + 교차 추론으로 새로 도출)
- SUPPORTED_BY = 지금의 큰 흐름 → 원국 년주 반합 / 올해 흐름 → 원국 년주 천간합 / 지금의 큰 흐름 기운이 용신에 부합
...
- 결론: 이 부분은 흐름이 맞물려 열리는 편입니다.
- 시기: (근거 없음 — 시점 언급 금지)
- 학문별 기여: MYUNGRI=FOR · ZIWEI=INSUFFICIENT_EVIDENCE · QIMEN=미적용
...
### MYUNGRI
- PRIMARY = **CONDITIONAL_FOR** (근거강도 STRONG · 확신 MEDIUM · 직접성 ADJACENT · 자료 EXACT)
- 결론: 이 부분은 부딪히는 지점이 있어 범위를 좁히는 쪽이 낫습니다.
- MAJOR_FACTS_USED: 원국 십신 배치, 원국 합충형파해, 월령, 통근·투간, 일간 강약(억부), 용신(억부), 대운, 세운, 월운, 원국×운 관계(종류·위치)
- 일간 강약: 신강
- 용신: 일간이 신강이라 힘을 덜어 주는 화을 용신으로 봅니다(억부).
- SUBJUDGMENTS:
    - RELATION_STABILITY = CONDITIONAL_FOR (WOLWOON/ADJACENT) — 이 부분은 부딪히는 지점이 있어 범위를 좁히는 쪽이 낫습니다.
    - CONFLICT = CONDITIONAL_FOR (NATAL/ADJACENT) — 흐름 자체가 지금 이 사주에 필요한 기운으로 들어오고 있습니다.
    - INFLUENCE = CONDITIONAL_FOR (NATAL/ADJACENT) — 흐름 자체가 지금 이 사주에 필요한 기운으로 들어오고 있습니다.
- COUNTER_EVIDENCE:
    - 올해 흐름 → 원국 일주 자형 — 배우자·자기 자리가 이 흐름에 직접 흔들립니다.
    - 이 시기 흐름 → 원국 일주 파 — 배우자·자기 자리가 이 흐름에 직접 흔들립니다.
...
### CROSS
- SAME_PROPOSITION_CONFLICT = 명리와 자미두수가 부딪힘을 반대로 봅니다.
- DOMAIN_DECOMPOSITION = 없음
- TEMPORAL_DECOMPOSITION = 없음
- AXIS_VERDICTS = RELATION_STABILITY:CONDITIONAL_FOR · CONFLICT:AGAINST(경합) · INFLUENCE:CONDITIONAL_FOR
- DOMINANT_EVIDENCE = 자미두수 · 전택(삼합궁)에 태양 화권
- LOSING_EVIDENCE = 명리가 본 원국 바탕(CONFLICT)도 사실이지만, 근거의 결이 한 단계 멀어 결론을 가져가지 못했습니다.
- RESOLUTION = 학문 사이의 차이를 근거의 직접성과 축·시점 기준으로 정리했습니다.
- **FINAL_VERDICT = AGAINST** (확신 MEDIUM)
- NEW_INFERENCE = 형제에 막히는 기운이 들어와, 이 부분은 수월하게 풀리지 않습니다.
- INFERENCE_IS_PRIMITIVE_FACT = NO (축별 판정 + 교차 추론으로 새로 도출)
- SUPPORTED_BY = 지금의 큰 흐름 기운이 용신에 부합 / 올해 흐름 기운이 용신에 부합 / 원국 바탕(INFLUENCE)
- COUNTER_EVIDENCE_REF = 올해 흐름 → 원국 일주 자형 / 이 시기 흐름 → 원국 일주 파 / 형제(본궁)에 문창 화기
- DISCIPLINES_CONTRIBUTING = MYUNGRI+ZIWEI
- TEMPORAL_SCOPE = WOLWOON/NATAL
- TRACEABLE = YES
...
- 용신: 일간이 신강이라 힘을 덜어 주는 화을 용신으로 봅니다(억부).
- SUBJUDGMENTS:
    - OPPORTUNITY = CONDITIONAL_FOR (NATAL/DIRECT) — 흐름 자체가 지금 이 사주에 필요한 기운으로 들어오고 있습니다.
    - OUTCOME = AGAINST (WOLWOON/ADJACENT) — 이 부분은 직접 흔들리는 자리가 있어, 그대로 밀고 가기 어렵습니다.
    - MONEY_INFLOW = CONDITIONAL_FOR (NATAL/ADJACENT) — 흐름 자체가 지금 이 사주에 필요한 기운으로 들어오고 있습니다.
    - CAREER = FOR (WOLWOON/ADJACENT) — 이 부분은 흐름이 맞물려 열리는 편입니다.
- COUNTER_EVIDENCE:
...
### CROSS
- SAME_PROPOSITION_CONFLICT = 없음
- DOMAIN_DECOMPOSITION = 기회가 오는 것과 그것을 잡아서 남는 것은 다르게 봅니다. 서로 다른 축이라 둘 다 사실입니다.
- TEMPORAL_DECOMPOSITION = 없음
- AXIS_VERDICTS = OPPORTUNITY:CONDITIONAL_FOR · OUTCOME:AGAINST · MONEY_INFLOW:CONDITIONAL_FOR · CAREER:FOR · TIMING:FOR
- DOMINANT_EVIDENCE = 명리 · 원국 바탕(OPPORTUNITY)
- LOSING_EVIDENCE = 질문의 축과 다른 축이라 결론을 뒤집지 않고 조건으로 붙습니다.
- RESOLUTION = 학문 사이의 차이를 근거의 직접성과 축·시점 기준으로 정리했습니다.
- **FINAL_VERDICT = CONDITIONAL_FOR** (확신 HIGH)
- NEW_INFERENCE = 흐름 자체가 지금 이 사주에 필요한 기운으로 들어오고 있습니다. 다만 기회가 오는 것과 그것을 잡아서 남는 것은 다르게 봅니다.
- INFERENCE_IS_PRIMITIVE_FACT = NO (축별 판정 + 교차 추론으로 새로 도출)
- SUPPORTED_BY = 원국 바탕(OPPORTUNITY) / 지금의 큰 흐름 기운이 용신에 부합 / 올해 흐름 기운이 용신에 부합
...
- TRACEABLE = YES
- 결론: 흐름 자체가 지금 이 사주에 필요한 기운으로 들어오고 있습니다. 다만 기회가 오는 것과 그것을 잡아서 남는 것은 다르게 봅니다.
- 시기: 지금 움직이는 것 자체는 무리가 없습니다.
...
- 결론: 들어온 것을 지키는 구조는 크게 새지 않습니다. 다만 자리가 열리는 것과 실속이 남는 것은 다르게 봅니다.
- 시기: (근거 없음 — 시점 언급 금지)
- 학문별 기여: MYUNGRI=CONDITIONAL_FOR · ZIWEI=CONDITIONAL_AGAINST · QIMEN=미적용
...
### MYUNGRI
- PRIMARY = **FOR** (근거강도 STRONG · 확신 MEDIUM · 직접성 ADJACENT · 자료 EXACT)
- 결론: 이 부분은 흐름이 맞물려 열리는 편입니다.
- MAJOR_FACTS_USED: 원국 십신 배치, 원국 합충형파해, 월령, 통근·투간, 일간 강약(억부), 용신(억부), 대운, 세운, 월운, 원국×운 관계(종류·위치)
- 일간 강약: 신강
- 용신: 일간이 신강이라 힘을 덜어 주는 화을 용신으로 봅니다(억부).
- SUBJUDGMENTS:
    ...
    - OPPORTUNITY = CONDITIONAL_FOR (NATAL/GENERAL) — 흐름 자체가 지금 이 사주에 필요한 기운으로 들어오고 있습니다.
    - MONEY_INFLOW = CONDITIONAL_FOR (NATAL/GENERAL) — 흐름 자체가 지금 이 사주에 필요한 기운으로 들어오고 있습니다.
- COUNTER_EVIDENCE:
    - 이 시기 흐름 → 원국 시주 천간충 — 말년·결과 자리가 이 흐름에 직접 흔들립니다.
...
- DOMAIN_DECOMPOSITION = 기회가 오는 것과 그것을 잡아서 남는 것은 다르게 봅니다. 서로 다른 축이라 둘 다 사실입니다.
- TEMPORAL_DECOMPOSITION = 없음
- AXIS_VERDICTS = CAREER:FOR · OUTCOME:AGAINST · OPPORTUNITY:CONDITIONAL_FOR · MONEY_INFLOW:CONDITIONAL_FOR · TIMING:FOR
- DOMINANT_EVIDENCE = 명리 · 이 시기 흐름 → 원국 월주 반합
- LOSING_EVIDENCE = 질문의 축과 다른 축이라 결론을 뒤집지 않고 조건으로 붙습니다.
- RESOLUTION = 학문 사이의 차이를 근거의 직접성과 축·시점 기준으로 정리했습니다.
- **FINAL_VERDICT = FOR** (확신 MEDIUM)
- NEW_INFERENCE = 이 부분은 흐름이 맞물려 열리는 편입니다. 다만 기회가 오는 것과 그것을 잡아서 남는 것은 다르게 봅니다.
- INFERENCE_IS_PRIMITIVE_FACT = NO (축별 판정 + 교차 추론으로 새로 도출)
- SUPPORTED_BY = 이 시기 흐름 → 원국 월주 반합 / 원국 바탕(CAREER) / 지금의 큰 흐름 기운이 용신에 부합
- COUNTER_EVIDENCE_REF = 이 시기 흐름 → 원국 시주 천간충
- DISCIPLINES_CONTRIBUTING = MYUNGRI+ZIWEI+QIMEN
- TEMPORAL_SCOPE = WOLWOON/NATAL/PRESENT_MOMENT
- TRACEABLE = YES
...
- TRACEABLE = YES
- 결론: 이 부분은 흐름이 맞물려 열리는 편입니다. 다만 기회가 오는 것과 그것을 잡아서 남는 것은 다르게 봅니다.
- 시기: 지금 움직이는 것 자체는 무리가 없습니다.
...
- Q1 verdict = **FOR** — 관록에 힘이 실려 열려 있는 자리입니다.
- Q1 axes = OUTCOME:CONDITIONAL_FOR · MONEY_INFLOW:AGAINST · CAREER:FOR · GENERAL:CONDITIONAL_AGAINST · TIMING:FOR
...
- Q2 verdict = **AGAINST** — 이 부분은 부딪히는 지점이 있어 범위를 좁히는 쪽이 낫습니다.
- Q2 axes = GENERAL:AGAINST · CAREER:FOR · RELATION_STABILITY:FOR_BUT_LATER · TIMING:FOR
- 후속 턴은 저장된 교차판정(divinationVerdict)을 decisionMeta로 이어받아 "왜요?"에서 같은 판정을 설명합니다.

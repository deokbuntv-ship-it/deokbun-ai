...
| 반사실 대조쌍 | 5 |
| 궁합 케이스 | 6 |
| 총 합성추론(SYNTHETIC_INFERENCE) 수 | 331 |
...
- PROPOSITIONS:
    ...
    - [PRIMITIVE] (MYUNGRI) 이 시기 흐름이 원국 시주 반합와 맞물려 풀린다.
        ← 이 시기 흐름 → 원국 시주 반합
    - [UNRECEIVED_OPPORTUNITY] (MYUNGRI) 이 시기 흐름에 지원·배움 쪽 기운이 들어와 이 축이 실제로 움직인다 그러나 원국에 그것을 받아 둘 자리가 없어, 움직임은 생겨도 손에 남는 형태가 되기는 어렵다.
        ← 이 시기 흐름 지원·배움 / 일간 강약: 판정 보류(채택 학파 없음)
    - [DIRECTION_VS_EXECUTION] (MYUNGRI) 전반은 가는 방향 자체는 바탕이 받쳐 주지만, 가까운 시기에 같은 자리가 흔들리고 있어 지금 크게 벌이는 실행만 따로 떼어 불리하게 본다.
        ← 원국 지원·배움 2자리 / 원국 득령 / 올해 흐름 → 원국 년주 자형
    - [DIRECTION_VS_EXECUTION] (MYUNGRI) 같이 사는 난도은 가는 방향 자체는 바탕이 받쳐 주지만, 가까운 시기에 같은 자리가 흔들리고 있어 지금 크게 벌이는 실행만 따로 떼어 불리하게 본다.
        ← 지금의 큰 흐름 → 원국 일주 천간합 / 올해 흐름 → 원국 일주 천간충 / 올해 흐름 → 원국 일주 충
    - [PRESSURE_AGAINST_CAPACITY] (MYUNGRI) 원국 일지(배우자·자기 자리)가 흔들리지만 되돌아올 바탕이 있어, 범위를 좁히면 감당할 수 있다.
        ← 원국 득령 / 원국 통근 ROOTED / 원국 일지 충·형·파·해
    - [PRESSURE_AGAINST_CAPACITY] (MYUNGRI) 원국 년주↔월주가 흔들리지만 되돌아올 바탕이 있어, 범위를 좁히면 감당할 수 있다.
        ← 원국 득령 / 원국 통근 ROOTED / 원국 년주↔월주 STEM_CLASH
    - [STRUCTURAL_PROFILE] (MYUNGRI) 이 명식은 재물, 자리·책임, 활동·표현, 경쟁·동료, 지원·배움 쪽 모두에 자리가 겹쳐 있어, 어느 축을 잡아도 받쳐 줄 바탕이 있는 구조다.
        ← 원국 재물 2자리 / 원국 자리·책임 3자리 / 원국 활동·표현 2자리
    - [CROSS_CONTRADICTION_RESOLVED] (CROSS) 재백에 화기가 들어와, 이 부분은 수월하게 풀리지 않고 막히기 쉽습니다. 반대 근거도 있으나, 한쪽은 막는 자리를 이름까지 짚어내고, 다른 쪽은 걸림돌을 짚어내지 못했습니다.
        ← 재백(본궁)에 천동 화기 / 지금의 큰 흐름 재물 / 관록(삼합궁)에 태음 화과
    ...
    - [CROSS_CONTRADICTION_RESOLVED] (CROSS) 관록에 화과가 들어와 있어 이름과 신뢰는 받쳐줍니다. 다만 실제로 들어오는 몫까지는 기대하기 어렵습니다. 반대 근거도 있으나, 한쪽은 막는 자리를 이름까지 짚어내고, 다른 쪽은 걸림돌을 짚어내지 못했습니다.
        ← 관록(본궁)에 태음 화과 / 지금의 큰 흐름 → 원국 월주 해 / 재백(삼합궁)에 천동 화기
    - [CROSS_TIMING_SPLIT] (CROSS) 돈이 들어오는 쪽은 가까운 시기에 움직일 여지가 보이지만 큰 흐름이 같은 자리를 받쳐주지 않습니다. 지금의 여지만 보고 크게 벌일 자리는 아닙니다.
        ← 재백(본궁)에 천동 화기 / 올해 흐름 재물 / 관록(삼합궁)에 태음 화과
...
- CONTRADICTION_RESOLUTIONS = DIRECTNESS: 재백에 화기가 들어와, 이 부분은 수월하게 풀리지 않고 막히기 쉽습니다. 반대 근거도 있으나, 한쪽은 막는 자리를 이름까지 짚어내고, 다른 쪽은 걸림돌을 짚어내지 못했습니다. / DIFFERENT_DOMAIN: 자리가 열리는 것과 실속이 남는 것은 다르게 봅니다. 돈이 남는 쪽은 열립니다, 자리·직업은 범위를 좁혀야 합니다. 둘 다 사실이라 나누어 말씀드립니다. / DIRECTNESS: 관록에 화과가 들어와 있어 이름과 신뢰는 받쳐줍니다. 다만 실제로 들어오는 몫까지는 기대하기 어렵습니다. 반대 근거도 있으나, 한쪽은 막는 자리를 이름까지 짚어내고, 다른 쪽은 걸림돌을 짚어내지 못했습니다. / DIFFERENT_TIMESCALE: 돈이 들어오는 쪽은 가까운 시기에 움직일 여지가 보이지만 큰 흐름이 같은 자리를 받쳐주지 않습니다. 지금의 여지만 보고 크게 벌일 자리는 아닙니다. / INFLOW_VS_RETENTION: 돈이 들어오는 것과 남는 것은 다르게 봅니다. 돈이 들어오는 쪽은 막힙니다, 돈이 남는 쪽은 열립니다. 둘 다 사실이라 나누어 말씀드립니다.
- WHY_OTHER_DID_NOT_DOMINATE = 한쪽은 막는 자리를 이름까지 짚어내고, 다른 쪽은 걸림돌을 짚어내지 못했습니다 (밀려난 쪽: 명리) / 서로 다른 축이라 결론을 뒤집지 않고 조건으로 붙습니다. / 한쪽은 막는 자리를 이름까지 짚어내고, 다른 쪽은 걸림돌을 짚어내지 못했습니다 (밀려난 쪽: 명리) / 서로 다른 축이라 결론을 뒤집지 않고 조건으로 붙습니다. / 서로 다른 축이라 결론을 뒤집지 않고 조건으로 붙습니다.
...
- ANSWERED_ON_ASKED_AXIS = YES (MONEY_INFLOW = CONDITIONAL_AGAINST)
- 결론: 돈이 들어오는 쪽과 남는 쪽은 이 명식에서 같은 답이 아니다. 유입은 움직이는데 보유 쪽에 반대 신호가 붙어 있어, 두 축을 나누어 답해야 한다.
- SYNTHETIC_INFERENCES = 12 / 21
- PROPOSITIONS:
    ...
    - [PRIMITIVE] (MYUNGRI) 올해 흐름이 원국 시주 천간합와 맞물려 풀린다.
        ← 올해 흐름 → 원국 시주 천간합
    - [DIRECTION_VS_EXECUTION] (MYUNGRI) 자리·직업은 가는 방향 자체는 바탕이 받쳐 주지만, 가까운 시기에 같은 자리가 흔들리고 있어 지금 크게 벌이는 실행만 따로 떼어 불리하게 본다.
        ← 원국 자리·책임 2자리 / 지금의 큰 흐름 → 원국 월주 천간합 / 올해 흐름 → 원국 월주 해
    - [PRESSURE_AGAINST_CAPACITY] (MYUNGRI) 원국 년주↔월주가 흔들리지만 되돌아올 바탕이 있어, 범위를 좁히면 감당할 수 있다.
        ← 원국 통근 PARTLY_ROOTED / 원국 년주↔월주 STEM_CLASH / 원국 년주↔일주 BRANCH_PUNISHMENT
    ...
    - [INFLOW_VS_RETENTION] (MYUNGRI) 돈이 들어오는 쪽과 남는 쪽은 이 명식에서 같은 답이 아니다. 유입은 움직이는데 보유 쪽에 반대 신호가 붙어 있어, 두 축을 나누어 답해야 한다.
        ← 원국 재물 4자리 / 이 시기 흐름 재물
    - [STRUCTURAL_PROFILE] (MYUNGRI) 이 명식은 재물, 자리·책임, 활동·표현, 경쟁·동료 쪽에 자리가 겹쳐 무게가 실려 있고, 지원·배움 쪽은 얇거나 비어 있다. 잘 쓰는 자리와 빌려 써야 하는 자리가 뚜렷하게 갈리는 구조다.
        ← 원국 재물 4자리 / 원국 자리·책임 2자리 / 원국 활동·표현 3자리
    - [PRIMITIVE] (ZIWEI) 재백에는 방향을 정할 만한 신호가 들어오지 않습니다.
        ← 재백의 무곡·천부
    - [PRIMITIVE] (ZIWEI) 관록에는 방향을 정할 만한 신호가 들어오지 않습니다.
        ← 관록의 염정
    - [CROSS_AXIS_COMPOUND] (CROSS) 기회가 오는 것과 그것을 잡아서 남는 것은 다르게 봅니다. 잡았을 때 남는 쪽은 막힙니다, 기회가 오는 쪽은 열립니다. 둘 다 사실이라 나누어 말씀드립니다.
        ← 지금의 큰 흐름 활동·표현 / 지금의 큰 흐름 → 원국 시주 파 / 올해 흐름 → 원국 시주 파
    - [CROSS_TIMING_SPLIT] (CROSS) 서로 미치는 영향은 가까운 시기에 움직일 여지가 보이지만 큰 흐름이 같은 자리를 받쳐주지 않습니다. 지금의 여지만 보고 크게 벌일 자리는 아닙니다.
        ← 지금의 큰 흐름 겁재 / 올해 흐름 경쟁·동료
    - [CROSS_TIMING_SPLIT] (CROSS) 같이 사는 난도은 가까운 시기에 움직일 여지가 보이지만 큰 흐름이 같은 자리를 받쳐주지 않습니다. 지금의 여지만 보고 크게 벌일 자리는 아닙니다.
        ← 원국 통근 PARTLY_ROOTED / 이 시기 흐름 → 원국 일주 천간합 / 원국 일지 충·형·파·해
    - [CROSS_REINFORCEMENT] (CROSS) 돈이 남는 쪽에 대해 서로 다른 학문이 각각의 근거로 같은 자리를 가리킵니다. 한쪽만 보고 내린 결론이 아니라는 뜻입니다.
        ← 원국 재물 4자리 / 형제(삼합궁)에 거문 화기 / 지금의 큰 흐름 겁재
- CONTRADICTION_RESOLUTIONS = OPPORTUNITY_VS_OUTCOME: 기회가 오는 것과 그것을 잡아서 남는 것은 다르게 봅니다. 잡았을 때 남는 쪽은 막힙니다, 기회가 오는 쪽은 열립니다. 둘 다 사실이라 나누어 말씀드립니다. / DIFFERENT_TIMESCALE: 서로 미치는 영향은 가까운 시기에 움직일 여지가 보이지만 큰 흐름이 같은 자리를 받쳐주지 않습니다. 지금의 여지만 보고 크게 벌일 자리는 아닙니다. / DIFFERENT_TIMESCALE: 같이 사는 난도은 가까운 시기에 움직일 여지가 보이지만 큰 흐름이 같은 자리를 받쳐주지 않습니다. 지금의 여지만 보고 크게 벌일 자리는 아닙니다.
...
- PROPOSITIONS:
    ...
    - [PRIMITIVE] (MYUNGRI) 이 시기 흐름이 원국 시주 반합와 맞물려 풀린다.
        ← 이 시기 흐름 → 원국 시주 반합
    - [STRUCTURAL_PROFILE] (MYUNGRI) 이 명식은 재물, 활동·표현, 경쟁·동료, 지원·배움 쪽에 자리가 겹쳐 무게가 실려 있고, 자리·책임 쪽은 얇거나 비어 있다. 잘 쓰는 자리와 빌려 써야 하는 자리가 뚜렷하게 갈리는 구조다.
        ← 원국 재물 4자리 / 원국 활동·표현 2자리 / 원국 경쟁·동료 3자리
    - [PRIMITIVE] (ZIWEI) 재백에는 방향을 정할 만한 신호가 들어오지 않습니다.
        ← 재백의 파군
    - [PRIMITIVE] (ZIWEI) 관록에는 방향을 정할 만한 신호가 들어오지 않습니다.
        ← 관록의 칠살
    - [CROSS_AXIS_COMPOUND] (CROSS) 기회가 오는 것과 그것을 잡아서 남는 것은 다르게 봅니다. 잡았을 때 남는 쪽은 범위를 좁혀야 합니다, 기회가 오는 쪽은 열립니다. 둘 다 사실이라 나누어 말씀드립니다.
        ← 지금의 큰 흐름 활동·표현 / 원국 득령 / 원국 통근 ROOTED
    - [CROSS_TIMING_SPLIT] (CROSS) 전반은 가까운 시기에 움직일 여지가 보이지만 큰 흐름이 같은 자리를 받쳐주지 않습니다. 지금의 여지만 보고 크게 벌일 자리는 아닙니다.
        ← 원국 득령 / 원국 통근 ROOTED / 올해 흐름 → 원국 년주 천간합
    - [CROSS_AXIS_COMPOUND] (CROSS) 자리가 열리는 것과 실속이 남는 것은 다르게 봅니다. 돈이 남는 쪽은 범위를 좁혀야 합니다, 자리·직업은 열립니다. 둘 다 사실이라 나누어 말씀드립니다.
        ← 이 시기 흐름 자리·책임 / 원국 재물 4자리 / 이 시기 흐름 → 원국 월주 반합
    - [CROSS_TIMING_SPLIT] (CROSS) 돈이 남는 쪽은 큰 흐름에서 방향이 열려 있는데 가까운 시기가 같은 자리를 누르고 있습니다. 방향과 시점을 나눠서 봐야 합니다.
        ← 전택(본궁)에 태양 화권 / 원국 재물 4자리 / 형제(삼합궁)에 문창 화기
    - [CROSS_AXIS_COMPOUND] (CROSS) 돈이 들어오는 것과 남는 것은 다르게 봅니다. 돈이 들어오는 쪽은 범위를 좁혀야 합니다, 돈이 남는 쪽은 열립니다. 둘 다 사실이라 나누어 말씀드립니다.
        ← 원국 재물 4자리 / 전택(본궁)에 태양 화권 / 형제(삼합궁)에 문창 화기
- CONTRADICTION_RESOLUTIONS = OPPORTUNITY_VS_OUTCOME: 기회가 오는 것과 그것을 잡아서 남는 것은 다르게 봅니다. 잡았을 때 남는 쪽은 범위를 좁혀야 합니다, 기회가 오는 쪽은 열립니다. 둘 다 사실이라 나누어 말씀드립니다. / DIFFERENT_TIMESCALE: 전반은 가까운 시기에 움직일 여지가 보이지만 큰 흐름이 같은 자리를 받쳐주지 않습니다. 지금의 여지만 보고 크게 벌일 자리는 아닙니다. / DIFFERENT_DOMAIN: 자리가 열리는 것과 실속이 남는 것은 다르게 봅니다. 돈이 남는 쪽은 범위를 좁혀야 합니다, 자리·직업은 열립니다. 둘 다 사실이라 나누어 말씀드립니다. / DIFFERENT_TIMESCALE: 돈이 남는 쪽은 큰 흐름에서 방향이 열려 있는데 가까운 시기가 같은 자리를 누르고 있습니다. 방향과 시점을 나눠서 봐야 합니다. / INFLOW_VS_RETENTION: 돈이 들어오는 것과 남는 것은 다르게 봅니다. 돈이 들어오는 쪽은 범위를 좁혀야 합니다, 돈이 남는 쪽은 열립니다. 둘 다 사실이라 나누어 말씀드립니다.
- WHY_OTHER_DID_NOT_DOMINATE = 서로 다른 축이라 결론을 뒤집지 않고 조건으로 붙습니다. / 서로 다른 축이라 결론을 뒤집지 않고 조건으로 붙습니다. / 서로 다른 축이라 결론을 뒤집지 않고 조건으로 붙습니다. / 서로 다른 축이라 결론을 뒤집지 않고 조건으로 붙습니다. / 서로 다른 축이라 결론을 뒤집지 않고 조건으로 붙습니다.
...
- MAJOR_FACTS_USED: 원국 십신 배치, 원국 합충형파해, 월령, 통근·투간, 대운, 세운, 월운, 원국×운 관계(종류·위치), 일간 강약·용신(판정 보류)
- SUBJUDGMENTS:
    - CAREER = CONDITIONAL_FOR (DAEWOON/ADJACENT) — 지금의 큰 흐름에 자리·책임 쪽 기운이 들어와 이 축이 실제로 움직인다.
    ...
    - GENERAL = CONDITIONAL_AGAINST (SEWOON/ADJACENT) — 올해 흐름에 지원·배움 쪽 기운이 들어와 이 축이 실제로 움직인다 그러나 원국에 그것을 받아 둘 자리가 없어, 움직임은 생겨도 손에 남는 형태가 되기는 어렵다.
    - GENERAL = FOR_BUT_LATER (SEWOON/ADJACENT) — 전반은 가는 방향 자체는 바탕이 받쳐 주지만, 가까운 시기에 같은 자리가 흔들리고 있어 지금 크게 벌이는 실행만 따로 떼어 불리하게 본다.
    - RELATION_STABILITY = CONDITIONAL_AGAINST (NATAL/ADJACENT) — 원국 일지(배우자·자기 자리)가 흔들리지만 되돌아올 바탕이 있어, 범위를 좁히면 감당할 수 있다.
    - GENERAL = CONDITIONAL_AGAINST (NATAL/ADJACENT) — 원국 년주↔월주가 흔들리지만 되돌아올 바탕이 있어, 범위를 좁히면 감당할 수 있다.
    - CAREER = CONDITIONAL_AGAINST (DAEWOON/ADJACENT) — 원국 월주 천간충가 흔들리지만 되돌아올 바탕이 있어, 범위를 좁히면 감당할 수 있다.
    - GENERAL = STRUCTURAL_ANSWER (NATAL/ADJACENT) — 이 명식은 재물, 자리·책임, 활동·표현, 경쟁·동료, 지원·배움 쪽 모두에 자리가 겹쳐 있어, 어느 축을 잡아도 받쳐 줄 바탕이 있는 구조다.
- COUNTER_EVIDENCE: (없음)
...
- 결론: 재백은 맞물린 자리에서 힘을 받는 편이라, 범위를 지키면 진행하실 만합니다.
- SYNTHETIC_INFERENCES = 10 / 18
- PROPOSITIONS:
    - [PRIMITIVE] (MYUNGRI) 올해 흐름이 원국 시주 반합와 맞물려 풀린다.
        ← 올해 흐름 → 원국 시주 반합
    - [PRIMITIVE] (MYUNGRI) 이 시기 흐름에 활동·표현 쪽 기운이 들어와 이 축이 실제로 움직인다.
        ← 이 시기 흐름 활동·표현
    - [UNRECEIVED_OPPORTUNITY] (MYUNGRI) 올해 흐름에 지원·배움 쪽 기운이 들어와 이 축이 실제로 움직인다 그러나 원국에 그것을 받아 둘 자리가 없어, 움직임은 생겨도 손에 남는 형태가 되기는 어렵다.
        ← 올해 흐름 지원·배움 / 일간 강약: 판정 보류(채택 학파 없음)
    - [DIRECTION_VS_EXECUTION] (MYUNGRI) 전반은 가는 방향 자체는 바탕이 받쳐 주지만, 가까운 시기에 같은 자리가 흔들리고 있어 지금 크게 벌이는 실행만 따로 떼어 불리하게 본다.
        ← 원국 지원·배움 2자리 / 원국 득령 / 지금의 큰 흐름 → 원국 년주 반합
    - [PRESSURE_AGAINST_CAPACITY] (MYUNGRI) 원국 일지(배우자·자기 자리)가 흔들리지만 되돌아올 바탕이 있어, 범위를 좁히면 감당할 수 있다.
        ← 원국 득령 / 원국 통근 ROOTED / 원국 일지 충·형·파·해
    - [PRESSURE_AGAINST_CAPACITY] (MYUNGRI) 원국 년주↔월주가 흔들리지만 되돌아올 바탕이 있어, 범위를 좁히면 감당할 수 있다.
        ← 원국 득령 / 원국 통근 ROOTED / 원국 년주↔월주 STEM_CLASH
    - [STRUCTURAL_PROFILE] (MYUNGRI) 이 명식은 재물, 자리·책임, 활동·표현, 경쟁·동료, 지원·배움 쪽 모두에 자리가 겹쳐 있어, 어느 축을 잡아도 받쳐 줄 바탕이 있는 구조다.
        ← 원국 재물 2자리 / 원국 자리·책임 2자리 / 원국 활동·표현 3자리
    - [PRIMITIVE] (ZIWEI) 재백은 맞물린 자리에서 힘을 받는 편이라, 범위를 지키면 진행하실 만합니다.
        ← 복덕(대궁)에 천기 화록
    - [CROSS_CONTRADICTION_RESOLVED] (CROSS) 관록 자체보다 맞물린 자리에서 걸리는 기운이 들어와, 지금 크게 벌이기는 쉽지 않습니다. 반대 근거도 있으나, 한쪽은 막는 자리를 이름까지 짚어내고, 다른 쪽은 걸림돌을 짚어내지 못했습니다.
        ← 부처(대궁)에 태음 화기 / 지금의 큰 흐름 자리·책임 / 지금의 큰 흐름 → 원국 월주 반합
    - [CROSS_TIMING_SPLIT] (CROSS) 자리·직업은 가까운 시기에 움직일 여지가 보이지만 큰 흐름이 같은 자리를 받쳐주지 않습니다. 지금의 여지만 보고 크게 벌일 자리는 아닙니다.
        ← 원국 득령 / 원국 통근 ROOTED / 올해 흐름 → 원국 월주 천간합
    - [CROSS_AXIS_COMPOUND] (CROSS) 자리가 열리는 것과 실속이 남는 것은 다르게 봅니다. 돈이 남는 쪽은 열립니다, 자리·직업은 범위를 좁혀야 합니다. 둘 다 사실이라 나누어 말씀드립니다.
        ← 원국 득령 / 원국 통근 ROOTED / 전택(본궁)에 자미 화과
- CONTRADICTION_RESOLUTIONS = DIRECTNESS: 관록 자체보다 맞물린 자리에서 걸리는 기운이 들어와, 지금 크게 벌이기는 쉽지 않습니다. 반대 근거도 있으나, 한쪽은 막는 자리를 이름까지 짚어내고, 다른 쪽은 걸림돌을 짚어내지 못했습니다. / DIFFERENT_TIMESCALE: 자리·직업은 가까운 시기에 움직일 여지가 보이지만 큰 흐름이 같은 자리를 받쳐주지 않습니다. 지금의 여지만 보고 크게 벌일 자리는 아닙니다. / DIFFERENT_DOMAIN: 자리가 열리는 것과 실속이 남는 것은 다르게 봅니다. 돈이 남는 쪽은 열립니다, 자리·직업은 범위를 좁혀야 합니다. 둘 다 사실이라 나누어 말씀드립니다.
- WHY_OTHER_DID_NOT_DOMINATE = 한쪽은 막는 자리를 이름까지 짚어내고, 다른 쪽은 걸림돌을 짚어내지 못했습니다 (밀려난 쪽: 명리) / 서로 다른 축이라 결론을 뒤집지 않고 조건으로 붙습니다. / 서로 다른 축이라 결론을 뒤집지 않고 조건으로 붙습니다.
- AXIS_VERDICTS = OUTCOME:CONDITIONAL_FOR · OPPORTUNITY:CONDITIONAL_FOR · GENERAL:CONDITIONAL_AGAINST · GENERAL:FOR_BUT_LATER · RELATION_STABILITY:CONDITIONAL_AGAINST · GENERAL:CONDITIONAL_AGAINST · GENERAL:STRUCTURAL_ANSWER · MONEY_INFLOW:FOR · CAREER:CONDITIONAL_AGAINST(경합) · CAREER:CONDITIONAL_AGAINST(경합) · MONEY_RETENTION:CONDITIONAL_FOR(경합)
- DOCTRINE_BLOCKERS = MYUNGRI: 일간 강약: 판정 보류(채택 학파 없음)
- 시기: (근거 없음 — 시점 언급 금지)
...
- CONTRADICTION_RESOLUTIONS = DIRECTNESS: 재백에 화기가 들어와, 이 부분은 수월하게 풀리지 않고 막히기 쉽습니다. 반대 근거도 있으나, 한쪽은 막는 자리를 이름까지 짚어내고, 다른 쪽은 걸림돌을 짚어내지 못했습니다. / DIFFERENT_DOMAIN: 자리가 열리는 것과 실속이 남는 것은 다르게 봅니다. 돈이 남는 쪽은 열립니다, 자리·직업은 범위를 좁혀야 합니다. 둘 다 사실이라 나누어 말씀드립니다. / DIRECTNESS: 관록에 화과가 들어와 있어 이름과 신뢰는 받쳐줍니다. 다만 실제로 들어오는 몫까지는 기대하기 어렵습니다. 반대 근거도 있으나, 한쪽은 막는 자리를 이름까지 짚어내고, 다른 쪽은 걸림돌을 짚어내지 못했습니다. / DIFFERENT_TIMESCALE: 돈이 들어오는 쪽은 가까운 시기에 움직일 여지가 보이지만 큰 흐름이 같은 자리를 받쳐주지 않습니다. 지금의 여지만 보고 크게 벌일 자리는 아닙니다. / INFLOW_VS_RETENTION: 돈이 들어오는 것과 남는 것은 다르게 봅니다. 돈이 남는 쪽은 열립니다, 돈이 들어오는 쪽은 막힙니다. 둘 다 사실이라 나누어 말씀드립니다.
- WHY_OTHER_DID_NOT_DOMINATE = 한쪽은 막는 자리를 이름까지 짚어내고, 다른 쪽은 걸림돌을 짚어내지 못했습니다 (밀려난 쪽: 명리) / 서로 다른 축이라 결론을 뒤집지 않고 조건으로 붙습니다. / 한쪽은 막는 자리를 이름까지 짚어내고, 다른 쪽은 걸림돌을 짚어내지 못했습니다 (밀려난 쪽: 명리) / 서로 다른 축이라 결론을 뒤집지 않고 조건으로 붙습니다. / 서로 다른 축이라 결론을 뒤집지 않고 조건으로 붙습니다.
...
- PROPOSITIONS:
    ...
    - [CROSS_CONTRADICTION_RESOLVED] (CROSS) 관록에 화과가 들어와 있어 이름과 신뢰는 받쳐줍니다. 다만 실제로 들어오는 몫까지는 기대하기 어렵습니다. 반대 근거도 있으나, 한쪽은 막는 자리를 이름까지 짚어내고, 다른 쪽은 걸림돌을 짚어내지 못했습니다.
        ← 관록(본궁)에 태음 화과 / 지금의 큰 흐름 → 원국 월주 해 / 재백(삼합궁)에 천동 화기
    - [CROSS_REINFORCEMENT] (CROSS) 전반에 대해 서로 다른 학문이 각각의 근거로 같은 자리를 가리킵니다. 한쪽만 보고 내린 결론이 아니라는 뜻입니다.
        ← 원국 득령 / 원국 통근 ROOTED / 재백(삼합궁)에 천동 화기
- CONTRADICTION_RESOLUTIONS = DIRECTNESS: 관록에 화과가 들어와 있어 이름과 신뢰는 받쳐줍니다. 다만 실제로 들어오는 몫까지는 기대하기 어렵습니다. 반대 근거도 있으나, 한쪽은 막는 자리를 이름까지 짚어내고, 다른 쪽은 걸림돌을 짚어내지 못했습니다.
- WHY_OTHER_DID_NOT_DOMINATE = 한쪽은 막는 자리를 이름까지 짚어내고, 다른 쪽은 걸림돌을 짚어내지 못했습니다 (밀려난 쪽: 명리)
...
- 결정 요인(구조): DIRECTION_VS_EXECUTION · 방향과 실행 시점
- MAJOR_FACTS_USED: 원국 십신 배치, 원국 합충형파해, 월령, 통근·투간, 대운, 세운, 월운, 원국×운 관계(종류·위치), 일간 강약·용신(판정 보류)
- SUBJUDGMENTS:
    - MONEY_INFLOW = CONDITIONAL_FOR (DAEWOON/ADJACENT) — 지금의 큰 흐름에 재물 쪽 기운이 들어와 이 축이 실제로 움직인다.
    - CAREER = CONDITIONAL_AGAINST (DAEWOON/ADJACENT) — 지금의 큰 흐름이 원국 월주 해에 마찰을 일으킨다.
...
- PROPOSITIONS:
    ...
    - [PRIMITIVE] (QIMEN) 지금 움직이는 것 자체는 무리가 없습니다.
        ← 값사 開門 (離궁)
    - [CROSS_TIMING_SPLIT] (CROSS) 같이 사는 난도은 큰 흐름에서 방향이 열려 있는데 가까운 시기가 같은 자리를 누르고 있습니다. 방향과 시점을 나눠서 봐야 합니다.
        ← 부처(본궁)에 태양 화록 / 지금의 큰 흐름 → 원국 일주 천간합 / 올해 흐름 → 원국 일주 천간충
    - [CROSS_CONTRADICTION_RESOLVED] (CROSS) 원국 일지(배우자·자기 자리)가 흔들리지만 되돌아올 바탕이 있어, 범위를 좁히면 감당할 수 있다. 반대 근거도 있으나, 한쪽은 막는 자리를 이름까지 짚어내고, 다른 쪽은 걸림돌을 짚어내지 못했습니다.
        ← 원국 득령 / 원국 통근 ROOTED / 부처(본궁)에 태양 화록
    - [CROSS_REINFORCEMENT] (CROSS) 전반에 대해 서로 다른 학문이 각각의 근거로 같은 자리를 가리킵니다. 한쪽만 보고 내린 결론이 아니라는 뜻입니다.
        ← 원국 득령 / 원국 통근 ROOTED / 재백(삼합궁)에 천동 화기
- CONTRADICTION_RESOLUTIONS = DIFFERENT_TIMESCALE: 같이 사는 난도은 큰 흐름에서 방향이 열려 있는데 가까운 시기가 같은 자리를 누르고 있습니다. 방향과 시점을 나눠서 봐야 합니다. / DIRECTNESS: 원국 일지(배우자·자기 자리)가 흔들리지만 되돌아올 바탕이 있어, 범위를 좁히면 감당할 수 있다. 반대 근거도 있으나, 한쪽은 막는 자리를 이름까지 짚어내고, 다른 쪽은 걸림돌을 짚어내지 못했습니다.
- WHY_OTHER_DID_NOT_DOMINATE = 서로 다른 축이라 결론을 뒤집지 않고 조건으로 붙습니다. / 한쪽은 막는 자리를 이름까지 짚어내고, 다른 쪽은 걸림돌을 짚어내지 못했습니다 (밀려난 쪽: 자미두수)
...
- 결정 요인(구조): STRUCTURAL_PROFILE · 원국의 무게중심
- MAJOR_FACTS_USED: 원국 십신 배치, 원국 합충형파해, 월령, 통근·투간, 대운, 세운, 월운, 원국×운 관계(종류·위치), 일간 강약·용신(판정 보류)
- SUBJUDGMENTS:
    - MONEY_INFLOW = CONDITIONAL_FOR (DAEWOON/ADJACENT) — 지금의 큰 흐름에 재물 쪽 기운이 들어와 이 축이 실제로 움직인다.
    - CAREER = CONDITIONAL_AGAINST (DAEWOON/ADJACENT) — 지금의 큰 흐름이 원국 월주 해에 마찰을 일으킨다.
...
- PROPOSITIONS:
    ...
    - [DIRECTION_VS_EXECUTION] (MYUNGRI) 전반은 가는 방향 자체는 바탕이 받쳐 주지만, 가까운 시기에 같은 자리가 흔들리고 있어 지금 크게 벌이는 실행만 따로 떼어 불리하게 본다.
        ← 원국 지원·배움 2자리 / 원국 득령 / 올해 흐름 → 원국 년주 자형
    - [RECURRING_FRICTION_CAUSE] (MYUNGRI) 반복해서 부딪히는 자리는 우연이 아니다. 원국 년주↔월주가 원국에서 이미 약하게 짜여 있는데, 지금 흐름이 같은 성격의 자리를 다시 건드리고 있어 같은 일이 되풀이된다.
        ← 원국 년주↔월주 STEM_CLASH / 원국 년주↔일주 BRANCH_CLASH / 원국 일주↔시주 BRANCH_HARM
    - [STRUCTURAL_PROFILE] (MYUNGRI) 이 명식은 재물, 자리·책임, 활동·표현, 경쟁·동료, 지원·배움 쪽 모두에 자리가 겹쳐 있어, 어느 축을 잡아도 받쳐 줄 바탕이 있는 구조다.
        ← 원국 재물 2자리 / 원국 자리·책임 3자리 / 원국 활동·표현 2자리
    - [CROSS_CONTRADICTION_RESOLVED] (CROSS) 관록에 화과가 들어와 있어 이름과 신뢰는 받쳐줍니다. 다만 실제로 들어오는 몫까지는 기대하기 어렵습니다. 반대 근거도 있으나, 한쪽은 막는 자리를 이름까지 짚어내고, 다른 쪽은 걸림돌을 짚어내지 못했습니다.
        ← 관록(본궁)에 태음 화과 / 지금의 큰 흐름 → 원국 월주 해 / 재백(삼합궁)에 천동 화기
    ...
    - [CROSS_REINFORCEMENT] (CROSS) 전반에 대해 서로 다른 학문이 각각의 근거로 같은 자리를 가리킵니다. 한쪽만 보고 내린 결론이 아니라는 뜻입니다.
        ← 원국 득령 / 원국 통근 ROOTED / 재백(삼합궁)에 천동 화기
- CONTRADICTION_RESOLUTIONS = DIRECTNESS: 관록에 화과가 들어와 있어 이름과 신뢰는 받쳐줍니다. 다만 실제로 들어오는 몫까지는 기대하기 어렵습니다. 반대 근거도 있으나, 한쪽은 막는 자리를 이름까지 짚어내고, 다른 쪽은 걸림돌을 짚어내지 못했습니다. / DIFFERENT_TIMESCALE: 같이 사는 난도은 큰 흐름에서 방향이 열려 있는데 가까운 시기가 같은 자리를 누르고 있습니다. 방향과 시점을 나눠서 봐야 합니다. / DIRECTNESS: 원국 일지(배우자·자기 자리)가 흔들리지만 되돌아올 바탕이 있어, 범위를 좁히면 감당할 수 있다. 반대 근거도 있으나, 한쪽은 막는 자리를 이름까지 짚어내고, 다른 쪽은 걸림돌을 짚어내지 못했습니다.
- WHY_OTHER_DID_NOT_DOMINATE = 한쪽은 막는 자리를 이름까지 짚어내고, 다른 쪽은 걸림돌을 짚어내지 못했습니다 (밀려난 쪽: 명리) / 서로 다른 축이라 결론을 뒤집지 않고 조건으로 붙습니다. / 한쪽은 막는 자리를 이름까지 짚어내고, 다른 쪽은 걸림돌을 짚어내지 못했습니다 (밀려난 쪽: 자미두수)
...
### MYUNGRI
- PRIMARY = **STRUCTURAL_ANSWER** (근거강도 MODERATE · 확신 MEDIUM · 직접성 ADJACENT · 자료 EXACT)
- 결론: 반복해서 부딪히는 자리는 우연이 아니다. 원국 일지(배우자·자기 자리)가 원국에서 이미 약하게 짜여 있는데, 지금 흐름이 같은 성격의 자리를 다시 건드리고 있어 같은 일이 되풀이된다.
- 결정 요인(구조): RECURRING_FRICTION_CAUSE · 원국 일지(배우자·자기 자리)
- MAJOR_FACTS_USED: 원국 십신 배치, 원국 합충형파해, 월령, 통근·투간, 대운, 세운, 월운, 원국×운 관계(종류·위치), 일간 강약·용신(판정 보류)
- SUBJUDGMENTS:
    - MONEY_INFLOW = CONDITIONAL_FOR (DAEWOON/ADJACENT) — 지금의 큰 흐름에 재물 쪽 기운이 들어와 이 축이 실제로 움직인다.
    - CAREER = CONDITIONAL_AGAINST (DAEWOON/ADJACENT) — 지금의 큰 흐름이 원국 월주 해에 마찰을 일으킨다.
    ...
    - RELATION_STABILITY = CONDITIONAL_AGAINST (NATAL/ADJACENT) — 원국 일지(배우자·자기 자리)가 흔들리지만 되돌아올 바탕이 있어, 범위를 좁히면 감당할 수 있다.
    - GENERAL = CONDITIONAL_AGAINST (NATAL/DIRECT) — 원국 년주↔월주가 흔들리지만 되돌아올 바탕이 있어, 범위를 좁히면 감당할 수 있다.
    - RELATION_STABILITY = STRUCTURAL_ANSWER (SEWOON/ADJACENT) — 반복해서 부딪히는 자리는 우연이 아니다. 원국 일지(배우자·자기 자리)가 원국에서 이미 약하게 짜여 있는데, 지금 흐름이 같은 성격의 자리를 다시 건드리고 있어 같은 일이 되풀이된다.
    - GENERAL = STRUCTURAL_ANSWER (NATAL/DIRECT) — 이 명식은 재물, 자리·책임, 활동·표현, 경쟁·동료, 지원·배움 쪽 모두에 자리가 겹쳐 있어, 어느 축을 잡아도 받쳐 줄 바탕이 있는 구조다.
- COUNTER_EVIDENCE:
    - 올해 흐름 → 원국 일주 천간충 — 올해 흐름이 원국 일주 천간충를 정면으로 흔든다.
    - 올해 흐름 → 원국 일주 충 — 올해 흐름이 원국 일주 충를 정면으로 흔든다.
...
- PROPOSITIONS:
    ...
    - [DIRECTION_VS_EXECUTION] (MYUNGRI) 전반은 가는 방향 자체는 바탕이 받쳐 주지만, 가까운 시기에 같은 자리가 흔들리고 있어 지금 크게 벌이는 실행만 따로 떼어 불리하게 본다.
        ← 원국 지원·배움 2자리 / 원국 득령 / 올해 흐름 → 원국 년주 자형
    - [RECURRING_FRICTION_CAUSE] (MYUNGRI) 반복해서 부딪히는 자리는 우연이 아니다. 원국 일지(배우자·자기 자리)가 원국에서 이미 약하게 짜여 있는데, 지금 흐름이 같은 성격의 자리를 다시 건드리고 있어 같은 일이 되풀이된다.
        ← 원국 일지 충·형·파·해 / 원국 년주↔월주 STEM_CLASH / 원국 년주↔일주 BRANCH_CLASH
    - [STRUCTURAL_PROFILE] (MYUNGRI) 이 명식은 재물, 자리·책임, 활동·표현, 경쟁·동료, 지원·배움 쪽 모두에 자리가 겹쳐 있어, 어느 축을 잡아도 받쳐 줄 바탕이 있는 구조다.
        ← 원국 재물 2자리 / 원국 자리·책임 3자리 / 원국 활동·표현 2자리
    - [CROSS_CONTRADICTION_RESOLVED] (CROSS) 관록에 화과가 들어와 있어 이름과 신뢰는 받쳐줍니다. 다만 실제로 들어오는 몫까지는 기대하기 어렵습니다. 반대 근거도 있으나, 한쪽은 막는 자리를 이름까지 짚어내고, 다른 쪽은 걸림돌을 짚어내지 못했습니다.
        ← 관록(본궁)에 태음 화과 / 지금의 큰 흐름 → 원국 월주 해 / 재백(삼합궁)에 천동 화기
...
- CONTRADICTION_RESOLUTIONS = DIRECTNESS: 관록에 화과가 들어와 있어 이름과 신뢰는 받쳐줍니다. 다만 실제로 들어오는 몫까지는 기대하기 어렵습니다. 반대 근거도 있으나, 한쪽은 막는 자리를 이름까지 짚어내고, 다른 쪽은 걸림돌을 짚어내지 못했습니다. / DIFFERENT_TIMESCALE: 같이 사는 난도은 큰 흐름에서 방향이 열려 있는데 가까운 시기가 같은 자리를 누르고 있습니다. 방향과 시점을 나눠서 봐야 합니다. / DIRECTNESS: 원국 일지(배우자·자기 자리)가 흔들리지만 되돌아올 바탕이 있어, 범위를 좁히면 감당할 수 있다. 반대 근거도 있으나, 한쪽은 막는 자리를 이름까지 짚어내고, 다른 쪽은 걸림돌을 짚어내지 못했습니다.
- WHY_OTHER_DID_NOT_DOMINATE = 한쪽은 막는 자리를 이름까지 짚어내고, 다른 쪽은 걸림돌을 짚어내지 못했습니다 (밀려난 쪽: 명리) / 서로 다른 축이라 결론을 뒤집지 않고 조건으로 붙습니다. / 한쪽은 막는 자리를 이름까지 짚어내고, 다른 쪽은 걸림돌을 짚어내지 못했습니다 (밀려난 쪽: 자미두수)
- AXIS_VERDICTS = MONEY_INFLOW:CONDITIONAL_FOR · OUTCOME:CONDITIONAL_FOR · MONEY_INFLOW:CONDITIONAL_FOR · OUTCOME:CONDITIONAL_FOR · OUTCOME:CONDITIONAL_FOR · GENERAL:CONDITIONAL_AGAINST · GENERAL:FOR_BUT_LATER · RELATION_STABILITY:STRUCTURAL_ANSWER · GENERAL:STRUCTURAL_ANSWER · CAREER:CONDITIONAL_FOR(경합) · RELATION_STABILITY:FOR_BUT_LATER(경합) · RELATION_STABILITY:CONDITIONAL_AGAINST(경합) · GENERAL:CONDITIONAL_AGAINST(경합)
- DOCTRINE_BLOCKERS = MYUNGRI: 일간 강약: 판정 보류(채택 학파 없음)
- 시기: (근거 없음 — 시점 언급 금지)
- 학문별 기여: MYUNGRI=STRUCTURAL_ANSWER · ZIWEI=CONDITIONAL_AGAINST · QIMEN=미적용
...
- PROPOSITIONS:
    ...
    - [CROSS_REINFORCEMENT] (CROSS) 전반에 대해 서로 다른 학문이 각각의 근거로 같은 자리를 가리킵니다. 한쪽만 보고 내린 결론이 아니라는 뜻입니다.
        ← 원국 득령 / 원국 통근 ROOTED / 재백(삼합궁)에 천동 화기
- CONTRADICTION_RESOLUTIONS = DIRECTNESS: 재백에 화기가 들어와, 이 부분은 수월하게 풀리지 않고 막히기 쉽습니다. 반대 근거도 있으나, 한쪽은 막는 자리를 이름까지 짚어내고, 다른 쪽은 걸림돌을 짚어내지 못했습니다. / DIRECTNESS: 관록에 화과가 들어와 있어 이름과 신뢰는 받쳐줍니다. 다만 실제로 들어오는 몫까지는 기대하기 어렵습니다. 반대 근거도 있으나, 한쪽은 막는 자리를 이름까지 짚어내고, 다른 쪽은 걸림돌을 짚어내지 못했습니다. / OPPORTUNITY_VS_OUTCOME: 기회가 오는 것과 그것을 잡아서 남는 것은 다르게 봅니다. 기회가 오는 쪽은 범위를 좁혀야 합니다, 잡았을 때 남는 쪽은 열립니다. 둘 다 사실이라 나누어 말씀드립니다. / DIFFERENT_TIMESCALE: 돈이 들어오는 쪽은 가까운 시기에 움직일 여지가 보이지만 큰 흐름이 같은 자리를 받쳐주지 않습니다. 지금의 여지만 보고 크게 벌일 자리는 아닙니다.
- WHY_OTHER_DID_NOT_DOMINATE = 한쪽은 막는 자리를 이름까지 짚어내고, 다른 쪽은 걸림돌을 짚어내지 못했습니다 (밀려난 쪽: 명리) / 한쪽은 막는 자리를 이름까지 짚어내고, 다른 쪽은 걸림돌을 짚어내지 못했습니다 (밀려난 쪽: 명리) / 서로 다른 축이라 결론을 뒤집지 않고 조건으로 붙습니다. / 서로 다른 축이라 결론을 뒤집지 않고 조건으로 붙습니다.
- AXIS_VERDICTS = OUTCOME:CONDITIONAL_FOR · OUTCOME:CONDITIONAL_FOR · OUTCOME:CONDITIONAL_FOR · GENERAL:CONDITIONAL_AGAINST · GENERAL:FOR_BUT_LATER · RELATION_STABILITY:FOR_BUT_LATER · RELATION_STABILITY:CONDITIONAL_AGAINST · GENERAL:STRUCTURAL_ANSWER · TIMING:CONDITIONAL_FOR · MONEY_INFLOW:CONDITIONAL_AGAINST(경합) · CAREER:CONDITIONAL_FOR(경합) · OPPORTUNITY:CONDITIONAL_AGAINST(경합) · MONEY_INFLOW:CONDITIONAL_AGAINST(경합) · GENERAL:CONDITIONAL_AGAINST(경합)
- DOCTRINE_BLOCKERS = MYUNGRI: 일간 강약: 판정 보류(채택 학파 없음)
- 시기: 전반은 가는 방향 자체는 바탕이 받쳐 주지만, 가까운 시기에 같은 자리가 흔들리고 있어 지금 크게 벌이는 실행만 따로 떼어 불리하게 본다.
...
### MYUNGRI
- PRIMARY = **CONDITIONAL_AGAINST** (근거강도 STRONG · 확신 HIGH · 직접성 DIRECT · 자료 EXACT)
- 결론: 이 시기 흐름에 지원·배움 쪽 기운이 들어와 이 축이 실제로 움직인다 그러나 원국에 그것을 받아 둘 자리가 없어, 움직임은 생겨도 손에 남는 형태가 되기는 어렵다.
- 결정 요인(구조): UNRECEIVED_OPPORTUNITY · 일간 강약 · 억부용신
- MAJOR_FACTS_USED: 원국 십신 배치, 원국 합충형파해, 월령, 통근·투간, 대운, 세운, 월운, 원국×운 관계(종류·위치), 일간 강약·용신(판정 보류)
- SUBJUDGMENTS:
    - MONEY_INFLOW = CONDITIONAL_FOR (DAEWOON/ADJACENT) — 지금의 큰 흐름에 재물 쪽 기운이 들어와 이 축이 실제로 움직인다.
    - CAREER = CONDITIONAL_AGAINST (DAEWOON/ADJACENT) — 지금의 큰 흐름이 원국 월주 해에 마찰을 일으킨다.
    ...
    - GENERAL = STRUCTURAL_ANSWER (NATAL/DIRECT) — 이 명식은 재물, 자리·책임, 활동·표현, 경쟁·동료, 지원·배움 쪽 모두에 자리가 겹쳐 있어, 어느 축을 잡아도 받쳐 줄 바탕이 있는 구조다.
- COUNTER_EVIDENCE:
    - 일간 강약: 판정 보류(채택 학파 없음) — 강약 등급과 억부용신은 채택된 학파가 없어 판정을 보류한다. 구조 요소는 모두 산출되어 있다.
...
- **FINAL_VERDICT = CONDITIONAL_AGAINST** (확신 HIGH)
- ANSWERED_ON_ASKED_AXIS = YES (GENERAL = CONDITIONAL_AGAINST)
- 결론: 전반에 대해 서로 다른 학문이 각각의 근거로 같은 자리를 가리킵니다. 한쪽만 보고 내린 결론이 아니라는 뜻입니다.
- SYNTHETIC_INFERENCES = 11 / 21
- PROPOSITIONS:
    - [PRIMITIVE] (MYUNGRI) 지금의 큰 흐름에 재물 쪽 기운이 들어와 이 축이 실제로 움직인다.
        ← 지금의 큰 흐름 재물
    - [PRIMITIVE] (MYUNGRI) 지금의 큰 흐름이 원국 시주 반합와 맞물려 풀린다.
...
- CONTRADICTION_RESOLUTIONS = DIRECTNESS: 관록에 화과가 들어와 있어 이름과 신뢰는 받쳐줍니다. 다만 실제로 들어오는 몫까지는 기대하기 어렵습니다. 반대 근거도 있으나, 한쪽은 막는 자리를 이름까지 짚어내고, 다른 쪽은 걸림돌을 짚어내지 못했습니다. / DIFFERENT_TIMESCALE: 같이 사는 난도은 큰 흐름에서 방향이 열려 있는데 가까운 시기가 같은 자리를 누르고 있습니다. 방향과 시점을 나눠서 봐야 합니다. / DIRECTNESS: 원국 일지(배우자·자기 자리)가 흔들리지만 되돌아올 바탕이 있어, 범위를 좁히면 감당할 수 있다. 반대 근거도 있으나, 한쪽은 막는 자리를 이름까지 짚어내고, 다른 쪽은 걸림돌을 짚어내지 못했습니다.
- WHY_OTHER_DID_NOT_DOMINATE = 한쪽은 막는 자리를 이름까지 짚어내고, 다른 쪽은 걸림돌을 짚어내지 못했습니다 (밀려난 쪽: 명리) / 서로 다른 축이라 결론을 뒤집지 않고 조건으로 붙습니다. / 한쪽은 막는 자리를 이름까지 짚어내고, 다른 쪽은 걸림돌을 짚어내지 못했습니다 (밀려난 쪽: 자미두수)
- AXIS_VERDICTS = MONEY_INFLOW:CONDITIONAL_FOR · OUTCOME:CONDITIONAL_FOR · MONEY_INFLOW:CONDITIONAL_FOR · OUTCOME:CONDITIONAL_FOR · OUTCOME:CONDITIONAL_FOR · GENERAL:CONDITIONAL_AGAINST · GENERAL:FOR_BUT_LATER · GENERAL:STRUCTURAL_ANSWER · GENERAL:STRUCTURAL_ANSWER · TIMING:CONDITIONAL_FOR · CAREER:CONDITIONAL_FOR(경합) · RELATION_STABILITY:FOR_BUT_LATER(경합) · RELATION_STABILITY:CONDITIONAL_AGAINST(경합) · GENERAL:CONDITIONAL_AGAINST(경합)
- DOCTRINE_BLOCKERS = MYUNGRI: 일간 강약: 판정 보류(채택 학파 없음)
- 시기: 전반은 가는 방향 자체는 바탕이 받쳐 주지만, 가까운 시기에 같은 자리가 흔들리고 있어 지금 크게 벌이는 실행만 따로 떼어 불리하게 본다.
...
- CONTRADICTION_RESOLUTIONS = DIRECTNESS: 재백에 화기가 들어와, 이 부분은 수월하게 풀리지 않고 막히기 쉽습니다. 반대 근거도 있으나, 한쪽은 막는 자리를 이름까지 짚어내고, 다른 쪽은 걸림돌을 짚어내지 못했습니다. / DIRECTNESS: 관록에 화과가 들어와 있어 이름과 신뢰는 받쳐줍니다. 다만 실제로 들어오는 몫까지는 기대하기 어렵습니다. 반대 근거도 있으나, 한쪽은 막는 자리를 이름까지 짚어내고, 다른 쪽은 걸림돌을 짚어내지 못했습니다. / OPPORTUNITY_VS_OUTCOME: 기회가 오는 것과 그것을 잡아서 남는 것은 다르게 봅니다. 기회가 오는 쪽은 범위를 좁혀야 합니다, 잡았을 때 남는 쪽은 열립니다. 둘 다 사실이라 나누어 말씀드립니다. / DIFFERENT_TIMESCALE: 돈이 들어오는 쪽은 가까운 시기에 움직일 여지가 보이지만 큰 흐름이 같은 자리를 받쳐주지 않습니다. 지금의 여지만 보고 크게 벌일 자리는 아닙니다.
- WHY_OTHER_DID_NOT_DOMINATE = 한쪽은 막는 자리를 이름까지 짚어내고, 다른 쪽은 걸림돌을 짚어내지 못했습니다 (밀려난 쪽: 명리) / 한쪽은 막는 자리를 이름까지 짚어내고, 다른 쪽은 걸림돌을 짚어내지 못했습니다 (밀려난 쪽: 명리) / 서로 다른 축이라 결론을 뒤집지 않고 조건으로 붙습니다. / 서로 다른 축이라 결론을 뒤집지 않고 조건으로 붙습니다.
- AXIS_VERDICTS = OUTCOME:CONDITIONAL_FOR · OUTCOME:CONDITIONAL_FOR · OUTCOME:CONDITIONAL_FOR · GENERAL:CONDITIONAL_AGAINST · GENERAL:FOR_BUT_LATER · RELATION_STABILITY:FOR_BUT_LATER · RELATION_STABILITY:CONDITIONAL_AGAINST · GENERAL:STRUCTURAL_ANSWER · MONEY_INFLOW:CONDITIONAL_AGAINST(경합) · CAREER:CONDITIONAL_FOR(경합) · OPPORTUNITY:CONDITIONAL_AGAINST(경합) · MONEY_INFLOW:CONDITIONAL_AGAINST(경합) · GENERAL:CONDITIONAL_AGAINST(경합)
- DOCTRINE_BLOCKERS = MYUNGRI: 일간 강약: 판정 보류(채택 학파 없음)
- 시기: (근거 없음 — 시점 언급 금지)
...
- PROPOSITIONS:
    ...
    - [UNRECEIVED_OPPORTUNITY] (MYUNGRI) 이 시기 흐름에 지원·배움 쪽 기운이 들어와 이 축이 실제로 움직인다 그러나 원국에 그것을 받아 둘 자리가 없어, 움직임은 생겨도 손에 남는 형태가 되기는 어렵다.
        ← 이 시기 흐름 지원·배움 / 일간 강약: 판정 보류(채택 학파 없음)
    - [DIRECTION_VS_EXECUTION] (MYUNGRI) 전반은 가는 방향 자체는 바탕이 받쳐 주지만, 가까운 시기에 같은 자리가 흔들리고 있어 지금 크게 벌이는 실행만 따로 떼어 불리하게 본다.
        ← 원국 지원·배움 3자리 / 원국 득령 / 올해 흐름 → 원국 년주 자형
    - [DIRECTION_VS_EXECUTION] (MYUNGRI) 같이 사는 난도은 가는 방향 자체는 바탕이 받쳐 주지만, 가까운 시기에 같은 자리가 흔들리고 있어 지금 크게 벌이는 실행만 따로 떼어 불리하게 본다.
        ← 지금의 큰 흐름 → 원국 일주 천간합 / 올해 흐름 → 원국 일주 천간충 / 올해 흐름 → 원국 일주 충
    - [PRESSURE_AGAINST_CAPACITY] (MYUNGRI) 원국 일지(배우자·자기 자리)가 흔들리지만 되돌아올 바탕이 있어, 범위를 좁히면 감당할 수 있다.
        ← 원국 득령 / 원국 통근 ROOTED / 원국 일지 충·형·파·해
    - [PRESSURE_AGAINST_CAPACITY] (MYUNGRI) 원국 년주↔월주가 흔들리지만 되돌아올 바탕이 있어, 범위를 좁히면 감당할 수 있다.
        ← 원국 득령 / 원국 통근 ROOTED / 원국 년주↔월주 STEM_CLASH
    - [STRUCTURAL_PROFILE] (MYUNGRI) 이 명식은 자리·책임, 경쟁·동료, 지원·배움 쪽에 자리가 겹쳐 무게가 실려 있고, 재물, 활동·표현 쪽은 얇거나 비어 있다. 잘 쓰는 자리와 빌려 써야 하는 자리가 뚜렷하게 갈리는 구조다.
        ← 원국 자리·책임 3자리 / 원국 경쟁·동료 3자리 / 원국 지원·배움 3자리
    - [PRIMITIVE] (ZIWEI) 명궁에는 방향을 정할 만한 신호가 들어오지 않습니다.
        ← 명궁의 탐랑
    - [PRIMITIVE] (ZIWEI) 관록에는 방향을 정할 만한 신호가 들어오지 않습니다.
        ← 관록의 칠살
    - [PRIMITIVE] (ZIWEI) 명궁에는 방향을 정할 만한 신호가 들어오지 않습니다.
        ← 명궁의 탐랑
    - [CROSS_REINFORCEMENT] (CROSS) 돈이 들어오는 쪽에 대해 서로 다른 학문이 각각의 근거로 같은 자리를 가리킵니다. 한쪽만 보고 내린 결론이 아니라는 뜻입니다.
        ← 지금의 큰 흐름 재물 / 복덕(대궁)에 무곡 화권
- CONTRADICTION_RESOLUTIONS = 없음
- WHY_OTHER_DID_NOT_DOMINATE = 해당 없음
- AXIS_VERDICTS = CAREER:CONDITIONAL_AGAINST · MONEY_INFLOW:CONDITIONAL_FOR · OUTCOME:CONDITIONAL_FOR · OUTCOME:CONDITIONAL_AGAINST · GENERAL:CONDITIONAL_AGAINST · GENERAL:FOR_BUT_LATER · RELATION_STABILITY:FOR_BUT_LATER · RELATION_STABILITY:CONDITIONAL_AGAINST · GENERAL:CONDITIONAL_AGAINST · GENERAL:STRUCTURAL_ANSWER · OPPORTUNITY:STRUCTURAL_ANSWER · CAREER:STRUCTURAL_ANSWER · GENERAL:STRUCTURAL_ANSWER · MONEY_INFLOW:CONDITIONAL_FOR(경합)
- DOCTRINE_BLOCKERS = MYUNGRI: 일간 강약: 판정 보류(채택 학파 없음)
- 시기: (근거 없음 — 시점 언급 금지)
...
- PROPOSITIONS:
    ...
    - [PRESSURE_AGAINST_CAPACITY] (MYUNGRI) 원국 년주↔월주가 흔들리지만 되돌아올 바탕이 있어, 범위를 좁히면 감당할 수 있다.
        ← 원국 득령 / 원국 통근 ROOTED / 원국 년주↔월주 STEM_CLASH
    - [STRUCTURAL_PROFILE] (MYUNGRI) 이 명식은 자리·책임, 경쟁·동료, 지원·배움 쪽에 자리가 겹쳐 무게가 실려 있고, 재물, 활동·표현 쪽은 얇거나 비어 있다. 잘 쓰는 자리와 빌려 써야 하는 자리가 뚜렷하게 갈리는 구조다.
        ← 원국 자리·책임 2자리 / 원국 경쟁·동료 2자리 / 원국 지원·배움 2자리
- CONTRADICTION_RESOLUTIONS = 없음
- WHY_OTHER_DID_NOT_DOMINATE = 해당 없음
...
- PROPOSITIONS:
    ...
    - [CROSS_REINFORCEMENT] (CROSS) 전반에 대해 서로 다른 학문이 각각의 근거로 같은 자리를 가리킵니다. 한쪽만 보고 내린 결론이 아니라는 뜻입니다.
        ← 원국 득령 / 원국 통근 ROOTED / 재백(삼합궁)에 천동 화기
- CONTRADICTION_RESOLUTIONS = DIRECTNESS: 재백에 화기가 들어와, 이 부분은 수월하게 풀리지 않고 막히기 쉽습니다. 반대 근거도 있으나, 한쪽은 막는 자리를 이름까지 짚어내고, 다른 쪽은 걸림돌을 짚어내지 못했습니다. / DIRECTNESS: 관록에 화과가 들어와 있어 이름과 신뢰는 받쳐줍니다. 다만 실제로 들어오는 몫까지는 기대하기 어렵습니다. 반대 근거도 있으나, 한쪽은 막는 자리를 이름까지 짚어내고, 다른 쪽은 걸림돌을 짚어내지 못했습니다. / DIFFERENT_TIMESCALE: 돈이 들어오는 쪽은 가까운 시기에 움직일 여지가 보이지만 큰 흐름이 같은 자리를 받쳐주지 않습니다. 지금의 여지만 보고 크게 벌일 자리는 아닙니다.
- WHY_OTHER_DID_NOT_DOMINATE = 한쪽은 막는 자리를 이름까지 짚어내고, 다른 쪽은 걸림돌을 짚어내지 못했습니다 (밀려난 쪽: 명리) / 한쪽은 막는 자리를 이름까지 짚어내고, 다른 쪽은 걸림돌을 짚어내지 못했습니다 (밀려난 쪽: 명리) / 서로 다른 축이라 결론을 뒤집지 않고 조건으로 붙습니다.
...
- PROPOSITIONS:
    ...
    - [CROSS_CONTRADICTION_RESOLVED] (CROSS) 관록에 화과가 들어와 있어 이름과 신뢰는 받쳐줍니다. 다만 실제로 들어오는 몫까지는 기대하기 어렵습니다. 반대 근거도 있으나, 한쪽은 막는 자리를 이름까지 짚어내고, 다른 쪽은 걸림돌을 짚어내지 못했습니다.
        ← 관록(본궁)에 태음 화과 / 지금의 큰 흐름 → 원국 월주 해 / 재백(삼합궁)에 천동 화기
    - [CROSS_TIMING_SPLIT] (CROSS) 돈이 들어오는 쪽은 가까운 시기에 움직일 여지가 보이지만 큰 흐름이 같은 자리를 받쳐주지 않습니다. 지금의 여지만 보고 크게 벌일 자리는 아닙니다.
        ← 재백(본궁)에 천동 화기 / 올해 흐름 재물 / 이 시기 흐름 재물
    - [CROSS_TIMING_SPLIT] (CROSS) 같이 사는 난도은 가까운 시기에 움직일 여지가 보이지만 큰 흐름이 같은 자리를 받쳐주지 않습니다. 지금의 여지만 보고 크게 벌일 자리는 아닙니다.
        ← 원국 득령 / 원국 통근 ROOTED / 이 시기 흐름 → 원국 일주 반합
    - [CROSS_REINFORCEMENT] (CROSS) 전반에 대해 서로 다른 학문이 각각의 근거로 같은 자리를 가리킵니다. 한쪽만 보고 내린 결론이 아니라는 뜻입니다.
        ← 원국 득령 / 원국 통근 ROOTED / 재백(삼합궁)에 천동 화기
- CONTRADICTION_RESOLUTIONS = DIRECTNESS: 재백에 화기가 들어와, 이 부분은 수월하게 풀리지 않고 막히기 쉽습니다. 반대 근거도 있으나, 한쪽은 막는 자리를 이름까지 짚어내고, 다른 쪽은 걸림돌을 짚어내지 못했습니다. / DIRECTNESS: 관록에 화과가 들어와 있어 이름과 신뢰는 받쳐줍니다. 다만 실제로 들어오는 몫까지는 기대하기 어렵습니다. 반대 근거도 있으나, 한쪽은 막는 자리를 이름까지 짚어내고, 다른 쪽은 걸림돌을 짚어내지 못했습니다. / DIFFERENT_TIMESCALE: 돈이 들어오는 쪽은 가까운 시기에 움직일 여지가 보이지만 큰 흐름이 같은 자리를 받쳐주지 않습니다. 지금의 여지만 보고 크게 벌일 자리는 아닙니다. / DIFFERENT_TIMESCALE: 같이 사는 난도은 가까운 시기에 움직일 여지가 보이지만 큰 흐름이 같은 자리를 받쳐주지 않습니다. 지금의 여지만 보고 크게 벌일 자리는 아닙니다.
- WHY_OTHER_DID_NOT_DOMINATE = 한쪽은 막는 자리를 이름까지 짚어내고, 다른 쪽은 걸림돌을 짚어내지 못했습니다 (밀려난 쪽: 명리) / 한쪽은 막는 자리를 이름까지 짚어내고, 다른 쪽은 걸림돌을 짚어내지 못했습니다 (밀려난 쪽: 명리) / 서로 다른 축이라 결론을 뒤집지 않고 조건으로 붙습니다. / 서로 다른 축이라 결론을 뒤집지 않고 조건으로 붙습니다.
...
### MYUNGRI
- PRIMARY = **STRUCTURAL_ANSWER** (근거강도 MODERATE · 확신 MEDIUM · 직접성 ADJACENT · 자료 EXACT)
- 결론: 이 명식은 재물, 자리·책임, 활동·표현, 경쟁·동료 쪽에 자리가 겹쳐 무게가 실려 있고, 지원·배움 쪽은 얇거나 비어 있다. 잘 쓰는 자리와 빌려 써야 하는 자리가 뚜렷하게 갈리는 구조다.
- 결정 요인(구조): STRUCTURAL_PROFILE · 원국의 무게중심
- MAJOR_FACTS_USED: 원국 십신 배치, 원국 합충형파해, 월령, 통근·투간, 대운, 세운, 월운, 원국×운 관계(종류·위치), 일간 강약·용신(판정 보류)
- SUBJUDGMENTS:
    - OPPORTUNITY = CONDITIONAL_FOR (DAEWOON/ADJACENT) — 지금의 큰 흐름에 활동·표현 쪽 기운이 들어와 이 축이 실제로 움직인다.
    ...
    - GENERAL = STRUCTURAL_ANSWER (NATAL/ADJACENT) — 이 명식은 재물, 자리·책임, 활동·표현, 경쟁·동료 쪽에 자리가 겹쳐 무게가 실려 있고, 지원·배움 쪽은 얇거나 비어 있다. 잘 쓰는 자리와 빌려 써야 하는 자리가 뚜렷하게 갈리는 구조다.
- COUNTER_EVIDENCE:
    - 원국 지원·배움 1자리 — 지원·배움 쪽 자리가 원국에 하나 있다.
...
- CONTRADICTION_RESOLUTIONS = OPPORTUNITY_VS_OUTCOME: 기회가 오는 것과 그것을 잡아서 남는 것은 다르게 봅니다. 잡았을 때 남는 쪽은 막힙니다, 기회가 오는 쪽은 열립니다. 둘 다 사실이라 나누어 말씀드립니다. / DIFFERENT_TIMESCALE: 서로 미치는 영향은 가까운 시기에 움직일 여지가 보이지만 큰 흐름이 같은 자리를 받쳐주지 않습니다. 지금의 여지만 보고 크게 벌일 자리는 아닙니다. / DIFFERENT_TIMESCALE: 같이 사는 난도은 가까운 시기에 움직일 여지가 보이지만 큰 흐름이 같은 자리를 받쳐주지 않습니다. 지금의 여지만 보고 크게 벌일 자리는 아닙니다.
- WHY_OTHER_DID_NOT_DOMINATE = 서로 다른 축이라 결론을 뒤집지 않고 조건으로 붙습니다. / 서로 다른 축이라 결론을 뒤집지 않고 조건으로 붙습니다. / 서로 다른 축이라 결론을 뒤집지 않고 조건으로 붙습니다.
- AXIS_VERDICTS = OPPORTUNITY:CONDITIONAL_FOR · INFLUENCE:CONDITIONAL_AGAINST · OUTCOME:CONDITIONAL_FOR · MONEY_RETENTION:CONDITIONAL_AGAINST · CAREER:FOR_BUT_LATER · GENERAL:CONDITIONAL_AGAINST · CAREER:STRUCTURAL_ANSWER · MONEY_INFLOW:CONDITIONAL_AGAINST · GENERAL:STRUCTURAL_ANSWER · HEALTH_ENERGY:FOR · GENERAL:STRUCTURAL_ANSWER · OUTCOME:CONDITIONAL_AGAINST(경합) · INFLUENCE:CONDITIONAL_AGAINST(경합) · RELATION_STABILITY:CONDITIONAL_AGAINST(경합)
- DOCTRINE_BLOCKERS = MYUNGRI: 일간 강약: 판정 보류(채택 학파 없음)
- 시기: (근거 없음 — 시점 언급 금지)
...
- PROPOSITIONS:
    ...
    - [CROSS_TIMING_SPLIT] (CROSS) 자리·직업은 가까운 시기에 움직일 여지가 보이지만 큰 흐름이 같은 자리를 받쳐주지 않습니다. 지금의 여지만 보고 크게 벌일 자리는 아닙니다.
        ← 원국 득령 / 원국 통근 ROOTED / 올해 흐름 → 원국 월주 천간합
- CONTRADICTION_RESOLUTIONS = DIRECTNESS: 관록 자체보다 맞물린 자리에서 걸리는 기운이 들어와, 지금 크게 벌이기는 쉽지 않습니다. 반대 근거도 있으나, 한쪽은 막는 자리를 이름까지 짚어내고, 다른 쪽은 걸림돌을 짚어내지 못했습니다. / DIFFERENT_TIMESCALE: 자리·직업은 가까운 시기에 움직일 여지가 보이지만 큰 흐름이 같은 자리를 받쳐주지 않습니다. 지금의 여지만 보고 크게 벌일 자리는 아닙니다.
- WHY_OTHER_DID_NOT_DOMINATE = 한쪽은 막는 자리를 이름까지 짚어내고, 다른 쪽은 걸림돌을 짚어내지 못했습니다 (밀려난 쪽: 명리) / 서로 다른 축이라 결론을 뒤집지 않고 조건으로 붙습니다.
- AXIS_VERDICTS = OUTCOME:CONDITIONAL_FOR · OPPORTUNITY:CONDITIONAL_FOR · GENERAL:CONDITIONAL_AGAINST · GENERAL:FOR_BUT_LATER · RELATION_STABILITY:CONDITIONAL_AGAINST · GENERAL:CONDITIONAL_AGAINST · GENERAL:STRUCTURAL_ANSWER · MOVEMENT:CONDITIONAL_AGAINST · GENERAL:STRUCTURAL_ANSWER · TIMING:CONDITIONAL_FOR · CAREER:CONDITIONAL_AGAINST(경합) · CAREER:CONDITIONAL_AGAINST(경합)
- DOCTRINE_BLOCKERS = MYUNGRI: 일간 강약: 판정 보류(채택 학파 없음)
- 시기: 전반은 가는 방향 자체는 바탕이 받쳐 주지만, 가까운 시기에 같은 자리가 흔들리고 있어 지금 크게 벌이는 실행만 따로 떼어 불리하게 본다.
- 학문별 기여: MYUNGRI=INSUFFICIENT_EVIDENCE · ZIWEI=CONDITIONAL_AGAINST · QIMEN=FOR
...
- 결정 요인(구조): 단일 근거 · 지금의 큰 흐름의 활동·표현
- MAJOR_FACTS_USED: 원국 십신 배치, 원국 합충형파해, 월령, 통근·투간, 대운, 세운, 월운, 원국×운 관계(종류·위치), 일간 강약·용신(판정 보류)
- SUBJUDGMENTS:
...
- PROPOSITIONS:
    ...
    - [DIRECTION_VS_EXECUTION] (MYUNGRI) 자리·직업은 가는 방향 자체는 바탕이 받쳐 주지만, 가까운 시기에 같은 자리가 흔들리고 있어 지금 크게 벌이는 실행만 따로 떼어 불리하게 본다.
        ← 원국 자리·책임 2자리 / 지금의 큰 흐름 → 원국 월주 천간합 / 올해 흐름 → 원국 월주 해
    - [PRESSURE_AGAINST_CAPACITY] (MYUNGRI) 원국 일지(배우자·자기 자리)가 흔들리지만 되돌아올 바탕이 있어, 범위를 좁히면 감당할 수 있다.
        ← 원국 통근 PARTLY_ROOTED / 원국 일지 충·형·파·해
    - [CONVERGENT_SEAT_PRESSURE] (MYUNGRI) 원국 월주 해에는 서로 다른 시기의 압력이 겹쳐 들어와, 한 번 스치는 일이 아니라 반복해서 건드려지는 자리다.
        ← 지금의 큰 흐름 → 원국 월주 해 / 올해 흐름 → 원국 월주 해
    ...
    - [CROSS_AXIS_COMPOUND] (CROSS) 기회가 오는 것과 그것을 잡아서 남는 것은 다르게 봅니다. 기회가 오는 쪽은 열립니다, 잡았을 때 남는 쪽은 막힙니다. 둘 다 사실이라 나누어 말씀드립니다.
        ← 지금의 큰 흐름 활동·표현 / 지금의 큰 흐름 → 원국 시주 파 / 올해 흐름 → 원국 시주 파
    - [CROSS_TIMING_SPLIT] (CROSS) 서로 미치는 영향은 가까운 시기에 움직일 여지가 보이지만 큰 흐름이 같은 자리를 받쳐주지 않습니다. 지금의 여지만 보고 크게 벌일 자리는 아닙니다.
        ← 지금의 큰 흐름 겁재 / 올해 흐름 경쟁·동료 / 이 시기 흐름 경쟁·동료
    - [CROSS_TIMING_SPLIT] (CROSS) 전반은 가까운 시기에 움직일 여지가 보이지만 큰 흐름이 같은 자리를 받쳐주지 않습니다. 지금의 여지만 보고 크게 벌일 자리는 아닙니다.
        ← 원국 통근 PARTLY_ROOTED / 이 시기 흐름 → 원국 년주 육합 / 원국 년주↔월주 STEM_CLASH
- CONTRADICTION_RESOLUTIONS = OPPORTUNITY_VS_OUTCOME: 기회가 오는 것과 그것을 잡아서 남는 것은 다르게 봅니다. 기회가 오는 쪽은 열립니다, 잡았을 때 남는 쪽은 막힙니다. 둘 다 사실이라 나누어 말씀드립니다. / DIFFERENT_TIMESCALE: 서로 미치는 영향은 가까운 시기에 움직일 여지가 보이지만 큰 흐름이 같은 자리를 받쳐주지 않습니다. 지금의 여지만 보고 크게 벌일 자리는 아닙니다. / DIFFERENT_TIMESCALE: 전반은 가까운 시기에 움직일 여지가 보이지만 큰 흐름이 같은 자리를 받쳐주지 않습니다. 지금의 여지만 보고 크게 벌일 자리는 아닙니다.
- WHY_OTHER_DID_NOT_DOMINATE = 서로 다른 축이라 결론을 뒤집지 않고 조건으로 붙습니다. / 서로 다른 축이라 결론을 뒤집지 않고 조건으로 붙습니다. / 서로 다른 축이라 결론을 뒤집지 않고 조건으로 붙습니다.
...
- CONTRADICTION_RESOLUTIONS = OPPORTUNITY_VS_OUTCOME: 기회가 오는 것과 그것을 잡아서 남는 것은 다르게 봅니다. 잡았을 때 남는 쪽은 범위를 좁혀야 합니다, 기회가 오는 쪽은 열립니다. 둘 다 사실이라 나누어 말씀드립니다. / DIFFERENT_TIMESCALE: 전반은 가까운 시기에 움직일 여지가 보이지만 큰 흐름이 같은 자리를 받쳐주지 않습니다. 지금의 여지만 보고 크게 벌일 자리는 아닙니다. / DIFFERENT_DOMAIN: 자리가 열리는 것과 실속이 남는 것은 다르게 봅니다. 돈이 남는 쪽은 범위를 좁혀야 합니다, 자리·직업은 열립니다. 둘 다 사실이라 나누어 말씀드립니다. / DIFFERENT_TIMESCALE: 돈이 남는 쪽은 큰 흐름에서 방향이 열려 있는데 가까운 시기가 같은 자리를 누르고 있습니다. 방향과 시점을 나눠서 봐야 합니다. / INFLOW_VS_RETENTION: 돈이 들어오는 것과 남는 것은 다르게 봅니다. 돈이 들어오는 쪽은 범위를 좁혀야 합니다, 돈이 남는 쪽은 열립니다. 둘 다 사실이라 나누어 말씀드립니다.
- WHY_OTHER_DID_NOT_DOMINATE = 서로 다른 축이라 결론을 뒤집지 않고 조건으로 붙습니다. / 서로 다른 축이라 결론을 뒤집지 않고 조건으로 붙습니다. / 서로 다른 축이라 결론을 뒤집지 않고 조건으로 붙습니다. / 서로 다른 축이라 결론을 뒤집지 않고 조건으로 붙습니다. / 서로 다른 축이라 결론을 뒤집지 않고 조건으로 붙습니다.
- AXIS_VERDICTS = OPPORTUNITY:CONDITIONAL_FOR · GENERAL:CONDITIONAL_FOR · OPPORTUNITY:CONDITIONAL_FOR · RELATION_STABILITY:CONDITIONAL_AGAINST · CAREER:CONDITIONAL_FOR · INFLUENCE:CONDITIONAL_AGAINST · CAREER:CONDITIONAL_FOR · RELATION_STABILITY:CONDITIONAL_AGAINST · OUTCOME:CONDITIONAL_FOR · GENERAL:STRUCTURAL_ANSWER · MONEY_INFLOW:STRUCTURAL_ANSWER · CAREER:STRUCTURAL_ANSWER · TIMING:CONDITIONAL_FOR · OUTCOME:CONDITIONAL_AGAINST(경합) · GENERAL:CONDITIONAL_AGAINST(경합) · MONEY_RETENTION:CONDITIONAL_AGAINST(경합) · MONEY_RETENTION:FOR_BUT_LATER(경합) · MONEY_INFLOW:CONDITIONAL_AGAINST(경합)
- DOCTRINE_BLOCKERS = MYUNGRI: 일간 강약: 판정 보류(채택 학파 없음)
- 시기: 돈이 남는 쪽은 큰 흐름에서 방향이 열려 있는데 가까운 시기가 같은 자리를 누르고 있습니다. 방향과 시점을 나눠서 봐야 합니다.
- 학문별 기여: MYUNGRI=CONDITIONAL_AGAINST · ZIWEI=INSUFFICIENT_EVIDENCE · QIMEN=FOR
...
- SUBJUDGMENTS:
    ...
    - GENERAL = CONDITIONAL_AGAINST (SEWOON/ADJACENT) — 올해 흐름에 지원·배움 쪽 기운이 들어와 이 축이 실제로 움직인다 그러나 원국에 그것을 받아 둘 자리가 없어, 움직임은 생겨도 손에 남는 형태가 되기는 어렵다.
    - GENERAL = CONDITIONAL_AGAINST (WOLWOON/ADJACENT) — 이 시기 흐름에 지원·배움 쪽 기운이 들어와 이 축이 실제로 움직인다 그러나 원국에 그것을 받아 둘 자리가 없어, 움직임은 생겨도 손에 남는 형태가 되기는 어렵다.
    - CAREER = FOR_BUT_LATER (WOLWOON/ADJACENT) — 자리·직업은 가는 방향 자체는 바탕이 받쳐 주지만, 가까운 시기에 같은 자리가 흔들리고 있어 지금 크게 벌이는 실행만 따로 떼어 불리하게 본다.
    - GENERAL = FOR_BUT_LATER (SEWOON/ADJACENT) — 전반은 가는 방향 자체는 바탕이 받쳐 주지만, 가까운 시기에 같은 자리가 흔들리고 있어 지금 크게 벌이는 실행만 따로 떼어 불리하게 본다.
    - RELATION_STABILITY = CONDITIONAL_AGAINST (NATAL/ADJACENT) — 원국 일지(배우자·자기 자리)가 흔들리지만 되돌아올 바탕이 있어, 범위를 좁히면 감당할 수 있다.
    - GENERAL = CONDITIONAL_AGAINST (NATAL/ADJACENT) — 원국 년주↔월주가 흔들리지만 되돌아올 바탕이 있어, 범위를 좁히면 감당할 수 있다.
    - CAREER = CONDITIONAL_AGAINST (DAEWOON/ADJACENT) — 원국 월주 천간충가 흔들리지만 되돌아올 바탕이 있어, 범위를 좁히면 감당할 수 있다.
    - OUTCOME = CONDITIONAL_AGAINST (WOLWOON/ADJACENT) — 원국 시주 충가 흔들리지만 되돌아올 바탕이 있어, 범위를 좁히면 감당할 수 있다.
    - GENERAL = STRUCTURAL_ANSWER (NATAL/ADJACENT) — 이 명식은 재물, 자리·책임, 활동·표현, 경쟁·동료, 지원·배움 쪽 모두에 자리가 겹쳐 있어, 어느 축을 잡아도 받쳐 줄 바탕이 있는 구조다.
- COUNTER_EVIDENCE: (없음)
...
- PROPOSITIONS:
    ...
    - [UNRECEIVED_OPPORTUNITY] (MYUNGRI) 이 시기 흐름에 지원·배움 쪽 기운이 들어와 이 축이 실제로 움직인다 그러나 원국에 그것을 받아 둘 자리가 없어, 움직임은 생겨도 손에 남는 형태가 되기는 어렵다.
        ← 이 시기 흐름 지원·배움 / 일간 강약: 판정 보류(채택 학파 없음)
    - [DIRECTION_VS_EXECUTION] (MYUNGRI) 자리·직업은 가는 방향 자체는 바탕이 받쳐 주지만, 가까운 시기에 같은 자리가 흔들리고 있어 지금 크게 벌이는 실행만 따로 떼어 불리하게 본다.
        ← 원국 자리·책임 2자리 / 지금의 큰 흐름 자리·책임 / 지금의 큰 흐름 → 원국 월주 반합
    - [DIRECTION_VS_EXECUTION] (MYUNGRI) 전반은 가는 방향 자체는 바탕이 받쳐 주지만, 가까운 시기에 같은 자리가 흔들리고 있어 지금 크게 벌이는 실행만 따로 떼어 불리하게 본다.
        ← 원국 지원·배움 2자리 / 원국 득령 / 지금의 큰 흐름 → 원국 년주 반합
    - [PRESSURE_AGAINST_CAPACITY] (MYUNGRI) 원국 일지(배우자·자기 자리)가 흔들리지만 되돌아올 바탕이 있어, 범위를 좁히면 감당할 수 있다.
        ← 원국 득령 / 원국 통근 ROOTED / 원국 일지 충·형·파·해
    - [PRESSURE_AGAINST_CAPACITY] (MYUNGRI) 원국 년주↔월주가 흔들리지만 되돌아올 바탕이 있어, 범위를 좁히면 감당할 수 있다.
        ← 원국 득령 / 원국 통근 ROOTED / 원국 년주↔월주 STEM_CLASH
    - [PRESSURE_AGAINST_CAPACITY] (MYUNGRI) 원국 시주 충가 흔들리지만 되돌아올 바탕이 있어, 범위를 좁히면 감당할 수 있다.
        ← 원국 득령 / 원국 통근 ROOTED / 이 시기 흐름 → 원국 시주 충
    - [STRUCTURAL_PROFILE] (MYUNGRI) 이 명식은 재물, 자리·책임, 활동·표현, 경쟁·동료, 지원·배움 쪽 모두에 자리가 겹쳐 있어, 어느 축을 잡아도 받쳐 줄 바탕이 있는 구조다.
        ← 원국 재물 2자리 / 원국 자리·책임 2자리 / 원국 활동·표현 3자리
    - [PRIMITIVE] (ZIWEI) 명궁에는 방향을 정할 만한 신호가 들어오지 않습니다.
        ← 명궁의 태양·거문
    ...
    - [CROSS_TIMING_SPLIT] (CROSS) 자리·직업은 가까운 시기에 움직일 여지가 보이지만 큰 흐름이 같은 자리를 받쳐주지 않습니다. 지금의 여지만 보고 크게 벌일 자리는 아닙니다.
        ← 원국 득령 / 원국 통근 ROOTED / 올해 흐름 → 원국 월주 천간합
- CONTRADICTION_RESOLUTIONS = DIFFERENT_TIMESCALE: 자리·직업은 가까운 시기에 움직일 여지가 보이지만 큰 흐름이 같은 자리를 받쳐주지 않습니다. 지금의 여지만 보고 크게 벌일 자리는 아닙니다.
- WHY_OTHER_DID_NOT_DOMINATE = 서로 다른 축이라 결론을 뒤집지 않고 조건으로 붙습니다.
- AXIS_VERDICTS = OUTCOME:CONDITIONAL_FOR · GENERAL:CONDITIONAL_AGAINST · GENERAL:CONDITIONAL_AGAINST · CAREER:FOR_BUT_LATER · GENERAL:FOR_BUT_LATER · RELATION_STABILITY:CONDITIONAL_AGAINST · GENERAL:CONDITIONAL_AGAINST · OUTCOME:CONDITIONAL_AGAINST · GENERAL:STRUCTURAL_ANSWER · DECISION:STRUCTURAL_ANSWER · MONEY_INFLOW:CONDITIONAL_FOR · GENERAL:STRUCTURAL_ANSWER · TIMING:FOR_BUT_LATER · CAREER:CONDITIONAL_AGAINST(경합)
- DOCTRINE_BLOCKERS = MYUNGRI: 일간 강약: 판정 보류(채택 학파 없음)
- 시기: 자리·직업은 가는 방향 자체는 바탕이 받쳐 주지만, 가까운 시기에 같은 자리가 흔들리고 있어 지금 크게 벌이는 실행만 따로 떼어 불리하게 본다.
...
### MYUNGRI
- PRIMARY = **CONDITIONAL_AGAINST** (근거강도 WEAK · 확신 MEDIUM · 직접성 DIRECT · 자료 REDUCED)
- 결론: 원국 일지(배우자·자기 자리)가 흔들리지만 되돌아올 바탕이 있어, 범위를 좁히면 감당할 수 있다.
- 결정 요인(구조): PRESSURE_AGAINST_CAPACITY · 원국 일지(배우자·자기 자리)
- MAJOR_FACTS_USED: 원국 십신 배치, 원국 합충형파해, 월령, 통근·투간, 세운, 월운, 원국×운 관계(종류·위치), 일간 강약·용신(판정 보류)
- SUBJUDGMENTS:
    - MONEY_INFLOW = CONDITIONAL_FOR (SEWOON/ADJACENT) — 올해 흐름에 재물 쪽 기운이 들어와 이 축이 실제로 움직인다.
    - GENERAL = CONDITIONAL_AGAINST (WOLWOON/ADJACENT) — 이 시기 흐름에 지원·배움 쪽 기운이 들어와 이 축이 실제로 움직인다 그러나 원국에 그것을 받아 둘 자리가 없어, 움직임은 생겨도 손에 남는 형태가 되기는 어렵다.
...
- CONTRADICTION_RESOLUTIONS = 없음
- WHY_OTHER_DID_NOT_DOMINATE = 해당 없음
- AXIS_VERDICTS = MONEY_INFLOW:CONDITIONAL_FOR · GENERAL:CONDITIONAL_AGAINST · GENERAL:FOR_BUT_LATER · RELATION_STABILITY:CONDITIONAL_AGAINST · GENERAL:CONDITIONAL_AGAINST · GENERAL:STRUCTURAL_ANSWER · TIMING:CONDITIONAL_FOR
- DOCTRINE_BLOCKERS = MYUNGRI: 일간 강약: 판정 보류(채택 학파 없음)
- 시기: 전반은 가는 방향 자체는 바탕이 받쳐 주지만, 가까운 시기에 같은 자리가 흔들리고 있어 지금 크게 벌이는 실행만 따로 떼어 불리하게 본다.
...
- SUBJUDGMENTS:
    ...
    - GENERAL = CONDITIONAL_AGAINST (NATAL/DIRECT) — 원국 년주↔월주가 흔들리지만 되돌아올 바탕이 있어, 범위를 좁히면 감당할 수 있다.
    - GENERAL = STRUCTURAL_ANSWER (SEWOON/DIRECT) — 반복해서 부딪히는 자리는 우연이 아니다. 원국 년주↔월주가 원국에서 이미 약하게 짜여 있는데, 지금 흐름이 같은 성격의 자리를 다시 건드리고 있어 같은 일이 되풀이된다.
    - GENERAL = STRUCTURAL_ANSWER (NATAL/DIRECT) — 이 명식은 자리·책임, 경쟁·동료, 지원·배움 쪽에 자리가 겹쳐 무게가 실려 있고, 재물, 활동·표현 쪽은 얇거나 비어 있다. 잘 쓰는 자리와 빌려 써야 하는 자리가 뚜렷하게 갈리는 구조다.
- COUNTER_EVIDENCE:
    - 일간 강약: 판정 보류(채택 학파 없음) — 강약 등급과 억부용신은 채택된 학파가 없어 판정을 보류한다. 구조 요소는 모두 산출되어 있다.
...
- PROPOSITIONS:
    ...
    - [PRESSURE_AGAINST_CAPACITY] (MYUNGRI) 원국 년주↔월주가 흔들리지만 되돌아올 바탕이 있어, 범위를 좁히면 감당할 수 있다.
        ← 원국 득령 / 원국 통근 ROOTED / 원국 년주↔월주 STEM_CLASH
    - [RECURRING_FRICTION_CAUSE] (MYUNGRI) 반복해서 부딪히는 자리는 우연이 아니다. 원국 년주↔월주가 원국에서 이미 약하게 짜여 있는데, 지금 흐름이 같은 성격의 자리를 다시 건드리고 있어 같은 일이 되풀이된다.
        ← 원국 년주↔월주 STEM_CLASH / 원국 년주↔일주 BRANCH_CLASH / 올해 흐름 → 원국 년주 자형
    - [STRUCTURAL_PROFILE] (MYUNGRI) 이 명식은 자리·책임, 경쟁·동료, 지원·배움 쪽에 자리가 겹쳐 무게가 실려 있고, 재물, 활동·표현 쪽은 얇거나 비어 있다. 잘 쓰는 자리와 빌려 써야 하는 자리가 뚜렷하게 갈리는 구조다.
        ← 원국 자리·책임 2자리 / 원국 경쟁·동료 2자리 / 원국 지원·배움 2자리
    - [PRIMITIVE] (QIMEN) 지금 움직이는 것 자체는 무리가 없습니다.
        ← 값사 開門 (離궁)
- CONTRADICTION_RESOLUTIONS = 없음
- WHY_OTHER_DID_NOT_DOMINATE = 해당 없음
- AXIS_VERDICTS = MONEY_INFLOW:CONDITIONAL_FOR · GENERAL:CONDITIONAL_AGAINST · GENERAL:FOR_BUT_LATER · RELATION_STABILITY:CONDITIONAL_AGAINST · GENERAL:CONDITIONAL_AGAINST · GENERAL:STRUCTURAL_ANSWER · GENERAL:STRUCTURAL_ANSWER · TIMING:CONDITIONAL_FOR
- DOCTRINE_BLOCKERS = MYUNGRI: 일간 강약: 판정 보류(채택 학파 없음)
- 시기: 전반은 가는 방향 자체는 바탕이 받쳐 주지만, 가까운 시기에 같은 자리가 흔들리고 있어 지금 크게 벌이는 실행만 따로 떼어 불리하게 본다.
- 학문별 기여: MYUNGRI=CONDITIONAL_AGAINST · ZIWEI=미적용 · QIMEN=FOR
...
- PROPOSITIONS:
    ...
    - [PRIMITIVE] (MYUNGRI) 이 시기 흐름이 원국 시주 반합와 맞물려 풀린다.
        ← 이 시기 흐름 → 원국 시주 반합
    - [PRESSURE_AGAINST_CAPACITY] (MYUNGRI) 원국 시주 천간충가 흔들리지만 되돌아올 바탕이 있어, 범위를 좁히면 감당할 수 있다.
        ← 원국 득령 / 원국 통근 ROOTED / 이 시기 흐름 → 원국 시주 천간충
    - [INFLOW_VS_RETENTION] (MYUNGRI) 돈이 들어오는 쪽과 남는 쪽은 이 명식에서 같은 답이 아니다. 유입은 움직이는데 보유 쪽에 반대 신호가 붙어 있어, 두 축을 나누어 답해야 한다.
        ← 원국 재물 4자리
    - [STRUCTURAL_PROFILE] (MYUNGRI) 이 명식은 재물, 활동·표현, 경쟁·동료, 지원·배움 쪽에 자리가 겹쳐 무게가 실려 있고, 자리·책임 쪽은 얇거나 비어 있다. 잘 쓰는 자리와 빌려 써야 하는 자리가 뚜렷하게 갈리는 구조다.
        ← 원국 재물 4자리 / 원국 활동·표현 2자리 / 원국 경쟁·동료 3자리
    ...
    - [CROSS_AXIS_COMPOUND] (CROSS) 자리가 열리는 것과 실속이 남는 것은 다르게 봅니다. 돈이 남는 쪽은 범위를 좁혀야 합니다, 자리·직업은 열립니다. 둘 다 사실이라 나누어 말씀드립니다.
        ← 이 시기 흐름 자리·책임 / 원국 재물 4자리 / 이 시기 흐름 → 원국 월주 반합
- CONTRADICTION_RESOLUTIONS = OPPORTUNITY_VS_OUTCOME: 기회가 오는 것과 그것을 잡아서 남는 것은 다르게 봅니다. 기회가 오는 쪽은 열립니다, 잡았을 때 남는 쪽은 범위를 좁혀야 합니다. 둘 다 사실이라 나누어 말씀드립니다. / DIFFERENT_TIMESCALE: 전반은 가까운 시기에 움직일 여지가 보이지만 큰 흐름이 같은 자리를 받쳐주지 않습니다. 지금의 여지만 보고 크게 벌일 자리는 아닙니다. / DIFFERENT_DOMAIN: 자리가 열리는 것과 실속이 남는 것은 다르게 봅니다. 돈이 남는 쪽은 범위를 좁혀야 합니다, 자리·직업은 열립니다. 둘 다 사실이라 나누어 말씀드립니다.
- WHY_OTHER_DID_NOT_DOMINATE = 서로 다른 축이라 결론을 뒤집지 않고 조건으로 붙습니다. / 서로 다른 축이라 결론을 뒤집지 않고 조건으로 붙습니다. / 서로 다른 축이라 결론을 뒤집지 않고 조건으로 붙습니다.
...
- CONTRADICTION_RESOLUTIONS = DIRECTNESS: 관록 자체보다 맞물린 자리에서 걸리는 기운이 들어와, 지금 크게 벌이기는 쉽지 않습니다. 반대 근거도 있으나, 한쪽은 막는 자리를 이름까지 짚어내고, 다른 쪽은 걸림돌을 짚어내지 못했습니다. / DIFFERENT_TIMESCALE: 자리·직업은 가까운 시기에 움직일 여지가 보이지만 큰 흐름이 같은 자리를 받쳐주지 않습니다. 지금의 여지만 보고 크게 벌일 자리는 아닙니다. / DIFFERENT_DOMAIN: 자리가 열리는 것과 실속이 남는 것은 다르게 봅니다. 돈이 남는 쪽은 열립니다, 자리·직업은 범위를 좁혀야 합니다. 둘 다 사실이라 나누어 말씀드립니다.
- WHY_OTHER_DID_NOT_DOMINATE = 한쪽은 막는 자리를 이름까지 짚어내고, 다른 쪽은 걸림돌을 짚어내지 못했습니다 (밀려난 쪽: 명리) / 서로 다른 축이라 결론을 뒤집지 않고 조건으로 붙습니다. / 서로 다른 축이라 결론을 뒤집지 않고 조건으로 붙습니다.
- AXIS_VERDICTS = OUTCOME:CONDITIONAL_FOR · OPPORTUNITY:CONDITIONAL_FOR · GENERAL:CONDITIONAL_AGAINST · GENERAL:FOR_BUT_LATER · RELATION_STABILITY:CONDITIONAL_AGAINST · GENERAL:CONDITIONAL_AGAINST · GENERAL:STRUCTURAL_ANSWER · MONEY_INFLOW:CONDITIONAL_FOR · CAREER:CONDITIONAL_AGAINST(경합) · CAREER:CONDITIONAL_AGAINST(경합) · MONEY_RETENTION:FOR(경합)
- DOCTRINE_BLOCKERS = MYUNGRI: 일간 강약: 판정 보류(채택 학파 없음)
- 시기: (근거 없음 — 시점 언급 금지)
- 학문별 기여: MYUNGRI=INSUFFICIENT_EVIDENCE · ZIWEI=CONDITIONAL_FOR · QIMEN=미적용
...
- 결정 요인(구조): PRESSURE_AGAINST_CAPACITY · 원국 년주↔월주
- MAJOR_FACTS_USED: 원국 십신 배치, 원국 합충형파해, 월령, 통근·투간, 대운, 세운, 월운, 원국×운 관계(종류·위치), 일간 강약·용신(판정 보류)
- SUBJUDGMENTS:
    - OPPORTUNITY = CONDITIONAL_FOR (DAEWOON/ADJACENT) — 지금의 큰 흐름에 활동·표현 쪽 기운이 들어와 이 축이 실제로 움직인다.
    - INFLUENCE = CONDITIONAL_AGAINST (DAEWOON/ADJACENT) — 지금의 큰 흐름에 같은 몫을 두고 겨루는 기운이 들어온다.
...
- CONTRADICTION_RESOLUTIONS = DIFFERENT_TIMESCALE: 자리·직업은 가까운 시기에 움직일 여지가 보이지만 큰 흐름이 같은 자리를 받쳐주지 않습니다. 지금의 여지만 보고 크게 벌일 자리는 아닙니다.
- WHY_OTHER_DID_NOT_DOMINATE = 서로 다른 축이라 결론을 뒤집지 않고 조건으로 붙습니다.
- AXIS_VERDICTS = CAREER:CONDITIONAL_FOR · CAREER:CONDITIONAL_FOR · OUTCOME:CONDITIONAL_FOR · OPPORTUNITY:CONDITIONAL_FOR · GENERAL:CONDITIONAL_AGAINST · GENERAL:FOR_BUT_LATER · RELATION_STABILITY:CONDITIONAL_AGAINST · GENERAL:CONDITIONAL_AGAINST · GENERAL:STRUCTURAL_ANSWER · RELATION_STABILITY:AGAINST · GENERAL:STRUCTURAL_ANSWER · CONFLICT:CONDITIONAL_FOR · TIMING:CONDITIONAL_FOR · CAREER:CONDITIONAL_AGAINST(경합)
- DOCTRINE_BLOCKERS = MYUNGRI: 일간 강약: 판정 보류(채택 학파 없음)
- 시기: 전반은 가는 방향 자체는 바탕이 받쳐 주지만, 가까운 시기에 같은 자리가 흔들리고 있어 지금 크게 벌이는 실행만 따로 떼어 불리하게 본다.
- 학문별 기여: MYUNGRI=CONDITIONAL_AGAINST · ZIWEI=AGAINST · QIMEN=FOR
...
- DIRECTION_MOVED = YES
- AXES_MOVED = OUTCOME: CONDITIONAL_FOR → CONDITIONAL_AGAINST · GENERAL: CONDITIONAL_AGAINST → STRUCTURAL_ANSWER · MONEY_INFLOW: CONDITIONAL_AGAINST → CONDITIONAL_FOR · CAREER: CONDITIONAL_FOR → STRUCTURAL_ANSWER · OPPORTUNITY: CONDITIONAL_AGAINST → STRUCTURAL_ANSWER
- 근거 차이: CROSS_AXIS_COMPOUND · 기회가 오는 것과 그것을 잡아서 남는 것  ⟷  해당 축 근거 없음
...
- DIRECTION_MOVED = YES
- AXES_MOVED = OUTCOME: CONDITIONAL_FOR → (없음) · GENERAL: CONDITIONAL_AGAINST → STRUCTURAL_ANSWER · MONEY_INFLOW: CONDITIONAL_AGAINST → CONDITIONAL_FOR · CAREER: CONDITIONAL_FOR → (없음) · OPPORTUNITY: CONDITIONAL_AGAINST → (없음)
- 근거 차이: CROSS_AXIS_COMPOUND · 기회가 오는 것과 그것을 잡아서 남는 것  ⟷  해당 축 근거 없음
...
- 근거 차이: 단일 근거 · 재백(삼합궁)에 천동 화기  ⟷  단일 근거 · 재백(삼합궁)에 천동 화기
...
- 근거 차이: CROSS_CONTRADICTION_RESOLVED · 재백(본궁)에 천동 화기  ⟷  CROSS_AXIS_COMPOUND · 자리가 열리는 것과 실속이 남는 것
...
- A = A · 돈 → **AGAINST**
- B = C · 돈 → **CONDITIONAL_AGAINST**
- DIRECTION_MOVED = YES
- AXES_MOVED = OUTCOME: CONDITIONAL_FOR → CONDITIONAL_AGAINST · GENERAL: STRUCTURAL_ANSWER → CONDITIONAL_AGAINST · MONEY_INFLOW: AGAINST → CONDITIONAL_AGAINST · MONEY_RETENTION: CONDITIONAL_FOR → FOR_BUT_LATER · CAREER: CONDITIONAL_FOR → STRUCTURAL_ANSWER · OPPORTUNITY: (없음) → CONDITIONAL_FOR · INFLUENCE: (없음) → CONDITIONAL_AGAINST
- 근거 차이: CROSS_CONTRADICTION_RESOLVED · 재백(본궁)에 천동 화기  ⟷  CROSS_AXIS_COMPOUND · 돈이 들어오는 것과 남는 것
...
- PROPOSITIONS:
    ...
    - [CROSS_REINFORCEMENT] (CROSS) 같이 사는 난도에 대해 서로 다른 학문이 각각의 근거로 같은 자리를 가리킵니다. 한쪽만 보고 내린 결론이 아니라는 뜻입니다.
...
- PROPOSITIONS:
    ...
    - [CROSS_CONTRADICTION_RESOLVED] (CROSS) 관계를 끌고 갈 동력이 있습니다. 반대 근거도 있으나, 한쪽은 확정된 입력에서 나왔고, 다른 쪽은 불확실한 입력에 기대고 있습니다.
        ← A 부처궁에 태양 화록 / 일지 충·형·해(배우자 자리)
    - [CROSS_AXIS_COMPOUND] (CROSS) 돈이 들어오는 것과 남는 것은 다르게 봅니다. 돈이 남는 쪽은 열립니다, 돈이 들어오는 쪽은 막힙니다. 둘 다 사실이라 나누어 말씀드립니다.
        ← A 재백궁에 천동 화기 / C 전택궁에 태양 화권
- CONTRADICTION_RESOLUTIONS = DIRECTNESS: 관계를 끌고 갈 동력이 있습니다. 반대 근거도 있으나, 한쪽은 확정된 입력에서 나왔고, 다른 쪽은 불확실한 입력에 기대고 있습니다. / INFLOW_VS_RETENTION: 돈이 들어오는 것과 남는 것은 다르게 봅니다. 돈이 남는 쪽은 열립니다, 돈이 들어오는 쪽은 막힙니다. 둘 다 사실이라 나누어 말씀드립니다.
- WHY_OTHER_DID_NOT_DOMINATE = 한쪽은 확정된 입력에서 나왔고, 다른 쪽은 불확실한 입력에 기대고 있습니다 (밀려난 쪽: 명리) / 서로 다른 축이라 결론을 뒤집지 않고 조건으로 붙습니다.

  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        // ⚠ 2026-09-12 #2 추가 (C9) — 답변 사본의 실제 보관 규칙. 마이그레이션 20260921 이 하는 일 그대로다.
        '[법률 검토] 상담 답변은 두 가지로 보관됩니다. 이용자의 상담 기록(대화 내용과 결과)은 이용자가 삭제를 요청하거나 회원 탈퇴를 할 때까지 보관합니다. 응답이 끊겼을 때 같은 답을 다시 보내기 위해 서버에 두는 답변 사본은 답변 후 24시간 동안만 보관하고, 그 뒤에는 원문을 지워 요청 식별자와 시각만 남깁니다(정리는 1시간마다 실행되어 늦어도 25시간 안에 지워집니다). 이용자가 대화를 삭제하면 그 대화의 기록과 서버 사본이 즉시 지워지고(삭제와 동시에 진행 중이던 답변처럼 대화와 연결되기 전의 사본은 위 24시간 기준으로 지워집니다), 그 대화로 만든 보고서의 공유 링크는 해지됩니다. 보고서는 운세우편함에 남으며 따로 삭제할 수 있고, 보고서를 삭제하면 그 공유 링크도 함께 지워집니다. 공유 링크가 해지되거나 만료되면 공유용 사본도 지워집니다.',
        // ⚠ 2026-09-13 추가 — CTO 판정: 운세 결과는 따로 보관 기한을 두지 않고 탈퇴 때 지운다. 명시한다.
        '[법률 검토] 오늘의 운세·이번 달 운세 결과는 운세우편함에서 다시 볼 수 있도록 따로 보관 기간을 두지 않고 보관하며, 회원 탈퇴 시 함께 삭제됩니다.',
        ...
        '공유 리포트 검증 정보는 문장 원문이 아닌 해시값이라 그 자체로 내용을 알 수 없으며, 대화를 삭제한 뒤에도 남아 있는 보고서를 다시 공유할 때 확인에 쓰이므로 회원 탈퇴 시 함께 삭제됩니다.',
      ],
    },
    {
      heading: '6. 이용자의 권리',
      paragraphs: [
        ...
        // ⚠ 2026-09-13 추가 — 대화·보고서를 탈퇴 없이 하나씩 지우는 길이 생겼다(오너 결정). 경로를 적는다.
        '상담 기록은 [MY] → [분석 대상자 관리] → [상담 기록]에서 상담마다 [상담 삭제]로, 보고서는 [운세우편함]에서 보고서를 연 뒤 [보고서 삭제](프리미엄 리포트는 [리포트 삭제])로 직접 삭제할 수 있습니다.',
      ],
    },
    {
      heading: '7. 문의',

...
const ENTRY = path.join(SRC, 'features/famous/server/index.ts');
const OUT = path.join(ROOT, 'supabase/functions/famous-compose/_server/famousBundle.mjs');
...
await esbuild.build({
  ...
  plugins: [atAlias],
  banner: {
    js: '// GENERATED FILE — do not edit. Source: src/features/famous/server/index.ts\n// Regenerate: node supabase/functions/famous-compose/_server/build.mjs',
  },
});
